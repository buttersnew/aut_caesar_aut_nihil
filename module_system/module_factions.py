...
factions = [
  ...
  ("kingdom_8",  "Dumnones",    0, 0.9, [("furor_teutonicus",-0.02),("egypt",-0.02),("alans",-0.02),("black_khergits",-0.02),("picton",-0.05),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("taiga_bandits", -0.05),("arabian_bandits", -0.05)], [], 0x5A1C10),
  ("kingdom_9",  "Corieltauvi",    0, 0.9, [("furor_teutonicus",-0.02),("egypt",-0.02),("alans",-0.02),("black_khergits",-0.02),("picton",-0.05),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("taiga_bandits", -0.05),("arabian_bandits", -0.05)], [], 0x214829),
  ...
  ("kingdom_24",  "Imperium Romanum Pars Otho",    0, 0.9, [("furor_teutonicus",-0.02),("egypt",-0.02),("alans",-0.02),("black_khergits",-0.9),("picton",-0.05),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", 0.5),("forest_bandits", -0.05),("taiga_bandits", -0.05),("arabian_bandits", -0.05)], [], 0x102810),
  ("kingdom_25",  "Imperium Romanum Pars Vespasianus",    0, 0.9, [("furor_teutonicus",-0.02),("egypt",-0.02),("alans",-0.02),("black_khergits",-0.9),("picton",-0.05),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", 0.5),("forest_bandits", -0.05),("taiga_bandits", -0.05),("arabian_bandits", -0.05)], [], 0x4A103A),
  ("kingdom_26",  "Imperium Romanum Pars Vitellius",    0, 0.9, [("furor_teutonicus",-0.02),("egypt",-0.02),("alans",-0.02),("black_khergits",-0.9),("picton",-0.05),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", 0.5),("forest_bandits", -0.05),("taiga_bandits", -0.05),("arabian_bandits", -0.05)], [], 0x4A0400),
  ("kingdom_27",  "Imperium Romanum Pars Galba",    0, 0.9, [("furor_teutonicus",-0.02),("egypt",-0.02),("alans",-0.02),("black_khergits",-0.9),("picton",-0.05),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", 0.5),("forest_bandits", -0.05),("taiga_bandits", -0.05),("arabian_bandits", -0.05)], [], 0x081429),
  ...
  ("mountain_bandits","Rebelles Iudaicus", 0, 0.5,[("commoners",-0.2),("black_khergits",-0.02),("merchants",-0.5),("player_faction",-0.15),("outlaws",-0.02),("forest_bandits",-0.02),("deserters",-0.02),("kingdom_17",0.5),], [], 0xE7AAC2),
  ("forest_bandits","Rebelles Hispanicus", 0, 0.5,[("commoners",-0.2),("merchants",-0.5),("player_faction",-0.15),("outlaws",-0.02),("mountain_bandits",-0.02),("deserters",-0.02),], [], 0xE7C36E),
