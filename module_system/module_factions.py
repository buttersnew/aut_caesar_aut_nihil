...
factions = [
  ...
  ("kingdom_18",  "Iazyges",    0, 0.9, [("furor_teutonicus",-0.02),("egypt",-0.02),("alans",-0.02),("black_khergits",-0.02),("picton",-0.05),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", 0.5),("forest_bandits", -0.05),("taiga_bandits", -0.05),("arabian_bandits", -0.05)], [], 0x988F84),
  ...
  ("mountain_bandits","Rebelles Iudaicus", 0, 0.5,[("commoners",-0.2),("black_khergits",-0.02),("merchants",-0.5),("player_faction",-0.15),("outlaws",-0.6),("forest_bandits",-0.02),("deserters",-0.02),("kingdom_17",0.5),], [], 0xE7AAC2),
