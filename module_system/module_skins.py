...
("elephant", 0,
  ...
  [],[
    ...
    (voice_die,"snd_elephant"),
    (voice_hit,"snd_elephant"),
    (voice_grunt,"snd_elephant"),
    (voice_grunt_long,"snd_elephant"),
    (voice_yell,"snd_elephant"),
    (voice_stun,"snd_elephant"),
    (voice_victory,"snd_elephant")
  ],"skel_human", 0.5,
...
("wild_cats", 0,
  ...
  [
    ...
    (voice_die,"snd_wild_cat"),
    (voice_hit,"snd_wild_cat"),
    (voice_grunt,"snd_wild_cat"),
    (voice_grunt_long,"snd_wild_cat"),
    (voice_yell,"snd_wild_cat"),
    (voice_stun,"snd_wild_cat"),
    (voice_victory,"snd_wild_cat")
  ],"skel_human", 0.5,
    psys_no_blood,psys_no_blood,
  [
    [1.7, comp_greater_than, (1.0,face_width), (1.0,temple_width)], #constraints: ex: 1.7 > (face_width + temple_width)
...
("wolf", 0,
  ...
  [],[
    ...
    (voice_die,"snd_wolf"),
    (voice_hit,"snd_wolf"),
    (voice_grunt,"snd_wolf"),
    (voice_grunt_long,"snd_wolf"),
    (voice_yell,"snd_wolf"),
    (voice_stun,"snd_wolf"),
    (voice_victory,"snd_wolf")
  ],"skel_human", 0.5,
  psys_no_blood,psys_no_blood,[
