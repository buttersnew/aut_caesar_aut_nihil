...
skills = [
  ("trade","Trade & Management",sf_base_att_int|sf_effects_party,10,"Each point in this skill reduces trade penalties by 5%%, ensuring better prices at market. This skill is also crucial for efficient administration of estates, workshops, and settlements. (Party&Personal Skill)"),
  ...
  ("oratory","Oratory",sf_base_att_cha,10,"This skill determines how good you are at holding a speech, but also helps to convince someone with an opposite opinion of you."), 
  ...
  ("trainer","Trainer",sf_base_att_int,5,"Every day, each hero with this skill adds some experience to every other member of the party whose level is lower than his/hers. Experience gained goes as: {0,4,10,16,23,30,38,46,55,65,80}. (Personal skill)"),
