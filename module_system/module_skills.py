...
skills = [
  ("trade","Trade",sf_base_att_int|sf_effects_party,10,"Every level of this skill reduces your trade penalty by 5%%. In addition, this skill helps you when you are confronted with management duties. (Party skill)"),
