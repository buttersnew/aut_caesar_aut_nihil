...
postfx_params = [
	("default", 		0, 0,	[125.9922, 1.0588, 1.4510, 9.1765],	[1.0000, 1.1373, 1.1373, 0.1961], 	[1.0000, 1.0000, 1.0000, 1.0000]),
	("map_params", 		0, 0,	[128.0000, 1.0400, 1.2941, 10.0000],	[1.0000, 2.1569, 1.8431, 0.4863], 	[1.0000, 1.0000, 1.0500, 1.0000]),
	("indoors", 		0, 0,	[128.0000, 1.0000, 1.2549, 10.0000],	[1.0000, 1.7843, 2.1616, 0.0016], 	[0.9804, 0.9804, 1.5294, 1.0000]),
	("sunset", 		0, 0,	[128.0000, 0.5882, 0.9804, 0.9804],	[1.0000, 2.1176, 1.3725, 0.1255], 	[0.9804, 0.9804, 1.7647, 1.0000]),
	("night", 		0, 0,	[128.0000, 1.0000, 1.2549, 10.0000],	[1.0000, 1.7843, 1.2157, 0.0000], 	[0.9804, 0.9804, 1.5294, 1.0000]),
	("sunny", 		0, 0,	[128.0000, 0.5882, 0.9804, 0.9804],	[1.0000, 2.1176, 1.3725, 0.1255], 	[0.9804, 0.9804, 1.7647, 1.0000]),
	("cloudy", 		0, 0,	[128.0000, 1.0000, 0.9804, 0.0000],	[1.0000, 2.6667, 2.0000, 0.4314], 	[0.9804, 0.9804, 1.4314, 1.0000]),
	("overcast", 		0, 0,	[128.0000, 1.0000, 0.9804, 0.0000],	[1.0000, 2.6667, 2.0000, 0.0000], 	[0.9804, 0.9804, 1.0314, 1.0000]),
