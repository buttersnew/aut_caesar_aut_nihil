...
# Towns:
    ...
    (call_script, "script_give_village_to_center", "p_village_78", "p_castle_4"),

    (call_script, "script_give_village_to_center", "p_village_195", "p_castle_12"),

    (call_script, "script_give_village_to_center", "p_village_17", "p_castle_39"),

    (call_script, "script_give_village_to_center", "p_village_8", "p_castle_35"),
    ...
    (call_script, "script_give_village_to_center", "p_village_160", "p_castle_78"),
    ...
    (call_script, "script_give_village_to_center", "p_village_155", "p_town_35"),
    ...
    (call_script, "script_give_village_to_center", "p_village_248", "p_town_36"),
    ...
    (call_script, "script_give_village_to_center", "p_village_172", "p_castle_55"),
    (call_script, "script_give_village_to_center", "p_village_257", "p_castle_65"),
   ...
   # Towns (loop)
    ...
    # also add notes for special places
    (try_for_range, ":holyside", "p_german_temple_1", "p_end_temple"),
        (add_party_note_tableau_mesh, ":holyside", "tableau_center_note_mesh"),
    (try_end),

    (add_party_note_tableau_mesh, "p_delphi", "tableau_center_note_mesh"),
    (add_party_note_tableau_mesh, "p_olympia", "tableau_center_note_mesh"),
    (add_party_note_tableau_mesh, "p_pyramids", "tableau_center_note_mesh"),
    (add_party_note_tableau_mesh, "p_hanging_gardens", "tableau_center_note_mesh"),
    (add_party_note_tableau_mesh, "p_tarquinii", "tableau_center_note_mesh"),
    (add_party_note_tableau_mesh, "p_royal_tombs", "tableau_center_note_mesh"),
    ...
    (party_set_slot, "p_castle_45", slot_center_culture, "fac_culture_judean"),
    (party_set_slot, "p_castle_46", slot_center_culture, "fac_culture_judean"),
    (party_set_slot, "p_village_98", slot_center_culture, "fac_culture_judean"),
    (party_set_slot, "p_village_97", slot_center_culture, "fac_culture_judean"),
    (party_set_slot, "p_village_96", slot_center_culture, "fac_culture_judean"),
    (party_set_slot, "p_village_109", slot_center_culture, "fac_culture_judean"),
    (party_set_slot, "p_village_51", slot_center_culture, "fac_culture_judean"),
    (party_set_slot, "p_village_100", slot_center_culture, "fac_culture_judean"),

    # syrian
    (party_set_slot, "p_town_47", slot_center_culture, "fac_culture_syrian"),
    (party_set_slot, "p_village_217", slot_center_culture, "fac_culture_syrian"),
    (party_set_slot, "p_village_218", slot_center_culture, "fac_culture_syrian"),
    (party_set_slot, "p_village_219", slot_center_culture, "fac_culture_syrian"),

    #egyptian
    (party_set_slot, "p_town_48", slot_center_culture, "fac_culture_egyptian"),
    (party_set_slot, "p_village_206", slot_center_culture, "fac_culture_egyptian"),
    (party_set_slot, "p_village_242", slot_center_culture, "fac_culture_egyptian"),
    (party_set_slot, "p_village_204", slot_center_culture, "fac_culture_egyptian"),
    (party_set_slot, "p_village_207", slot_center_culture, "fac_culture_egyptian"),
    (party_set_slot, "p_village_203", slot_center_culture, "fac_culture_egyptian"),
    (party_set_slot, "p_village_202", slot_center_culture, "fac_culture_egyptian"),
    (party_set_slot, "p_village_95", slot_center_culture, "fac_culture_egyptian"),

    #greek
    (party_set_slot, "p_town_35", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_town_36", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_town_37", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_town_38", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_castle_31", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_castle_6", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_town_10", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_castle_62", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_castle_63", slot_center_culture, "fac_culture_greek"),

    (party_set_slot, "p_village_53", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_248", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_159", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_69", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_155", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_161", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_162", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_71", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_73", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_166", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_50", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_156", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_33", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_41", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_227", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_90", slot_center_culture, "fac_culture_greek"),
    (party_set_slot, "p_village_88", slot_center_culture, "fac_culture_greek"),

    #berber
    (party_set_slot, "p_town_21", slot_center_culture, "fac_culture_berber"),
    (party_set_slot, "p_castle_64", slot_center_culture, "fac_culture_berber"),
    (party_set_slot, "p_castle_43", slot_center_culture, "fac_culture_berber"),
    (party_set_slot, "p_village_48", slot_center_culture, "fac_culture_berber"),
    (party_set_slot, "p_village_106", slot_center_culture, "fac_culture_berber"),
    (party_set_slot, "p_village_104", slot_center_culture, "fac_culture_berber"),
    ...
    (try_for_range, ":center_no", walled_centers_begin, walled_centers_end),#add town garrisons
        ...
        (try_begin),
            (this_or_next|faction_slot_eq, ":faction", slot_faction_culture, "fac_culture_syrian"),## to help syrians
            (this_or_next|faction_slot_eq, ":faction", slot_faction_culture, "fac_culture_sarmatian"),###to help nomads to survive
            (faction_slot_eq, ":faction", slot_faction_culture, "fac_culture_germanic"),##to help germans
            (val_add, ":garrison_strength", 25),
        (try_end),
            ####

        (call_script, "script_update_center_garrison", ":center_no", ":faction"),
    ...
    # also add notes for special places
    (try_for_range, ":holyside", "p_german_temple_1", "p_end_temple"),
        (party_set_note_available, ":holyside", 1),
    (try_end),

    (party_set_note_available, "p_delphi", 1),
    (party_set_note_available, "p_olympia", 1),
    (party_set_note_available, "p_pyramids", 1),
    (party_set_note_available, "p_hanging_gardens", 1),
    (party_set_note_available, "p_tarquinii", 1),
    (party_set_note_available, "p_royal_tombs", 1),
    ...
    (try_for_range, ":party", villages_begin, villages_end),
        ...
        (else_try),
            (eq, ":faction", "fac_culture_syrian"),
            (party_set_icon, ":party", "icon_village_greek"),
        (else_try),
            (eq, ":faction", "fac_culture_egyptian"),
            (party_set_icon, ":party", "icon_village_greek"),
        (else_try),
            (eq, ":faction", "fac_culture_greek"),
            (party_set_icon, ":party", "icon_village_greek"),
        (else_try),
...
("game_quick_start",[
    ...
    (faction_set_slot, "fac_kingdom_5", slot_faction_quick_battle_tier_1_infantry, "trp_armenian_spear_levy_vet"),
    (faction_set_slot, "fac_kingdom_5", slot_faction_quick_battle_tier_2_infantry, "trp_armenian_heavy_inf_vet"),
    (faction_set_slot, "fac_kingdom_5", slot_faction_quick_battle_tier_1_archer, "trp_armenian_slinger_vet"),
    (faction_set_slot, "fac_kingdom_5", slot_faction_quick_battle_tier_2_archer, "trp_armenian_elite_infantry_vet"),
    (faction_set_slot, "fac_kingdom_5", slot_faction_quick_battle_tier_1_cavalry, "trp_armenian_medium_horseman_vet"),
    (faction_set_slot, "fac_kingdom_5", slot_faction_quick_battle_tier_2_cavalry, "trp_armenian_cataphract_vet"),
    ...
    (faction_set_slot, "fac_kingdom_8", slot_faction_quick_battle_tier_1_infantry, "trp_legio_xxii_primigenia"),
    (faction_set_slot, "fac_kingdom_8", slot_faction_quick_battle_tier_2_infantry, "trp_legio_xxii_primigenia"),
    ...
    (faction_set_slot, "fac_kingdom_8", slot_faction_quick_battle_tier_1_cavalry, "trp_vexilarius_xxii"),
    (faction_set_slot, "fac_kingdom_8", slot_faction_quick_battle_tier_2_cavalry, "trp_aquilifer_xxii"),
...
("game_set_scenes_for_towns",[
    ...
    # Towns (loop)
    (try_for_range, ":town_no", towns_begin, towns_end),#ich verwend die selben scenen, sonst werd ich wahnsinnig
        (this_or_next|party_slot_eq, ":town_no", slot_center_culture, "fac_culture_roman"),#romer
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_greek"),#greek
    ...
    (else_try),
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_dacian"),#dacer
    ...
    (else_try),
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_sarmatian"),#nomaden
    ...
    (else_try),
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_bosporan"),#bosporian
    ...
    (else_try),
        (this_or_next|party_slot_eq, ":town_no", slot_center_culture, "fac_culture_celtic"),#britten
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_caledonian"),#britten
    ...
    (else_try),
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_germanic"),#germanen
    ...
    (else_try),
        (this_or_next|party_slot_eq, ":town_no", slot_center_culture, "fac_culture_egyptian"),#eastern
        (this_or_next|party_slot_eq, ":town_no", slot_center_culture, "fac_culture_syrian"),#eastern
        (this_or_next|party_slot_eq, ":town_no", slot_center_culture, "fac_culture_caucasian"),#eastern
        (this_or_next|party_slot_eq, ":town_no", slot_center_culture, "fac_culture_judean"),#eastern
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_parthian"),
    ...
    (else_try),
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_berber"),
        (party_set_slot,":town_no", slot_town_center, "scn_town_berber_center"),
        (party_set_slot,":town_no", slot_town_castle, "scn_town_berber_castle"),
        (party_set_slot,":town_no", slot_town_prison, "scn_town_berber_prison"),
        (party_set_slot,":town_no", slot_town_walls, "scn_town_berber_walls"),
        (party_set_slot,":town_no", slot_town_tavern, "scn_town_berber_tavern"),
        (party_set_slot,":town_no", slot_town_store, "scn_town_berber_store"),
        (party_set_slot,":town_no", slot_town_arena, "scn_town_berber_arena"),
    (else_try),
        (party_slot_eq, ":town_no", slot_center_culture, "fac_culture_garamantian"),
        (party_set_slot,":town_no", slot_town_center, "scn_town_garamantian_center"),
        (party_set_slot,":town_no", slot_town_castle, "scn_town_garamantian_castle"),
        (party_set_slot,":town_no", slot_town_prison, "scn_town_garamantian_prison"),
        (party_set_slot,":town_no", slot_town_walls, "scn_town_garamantian_walls"),
        (party_set_slot,":town_no", slot_town_tavern, "scn_town_garamantian_tavern"),
        (party_set_slot,":town_no", slot_town_store, "scn_town_garamantian_store"),
        (party_set_slot,":town_no", slot_town_arena, "scn_town_garamantian_arena"),
    (try_end),
    #special towns
    ...
    (else_try),
        (this_or_next|party_slot_eq, ":castle_no", slot_center_culture, "fac_culture_egyptian"),
        (this_or_next|party_slot_eq, ":castle_no", slot_center_culture, "fac_culture_syrian"),
        (this_or_next|party_slot_eq, ":castle_no", slot_center_culture, "fac_culture_caucasian"),
    ...
    (else_try),
        (party_slot_eq, ":castle_no", slot_center_culture, "fac_culture_berber"),
        (party_set_slot,":castle_no", slot_town_center, "scn_castle_berber_exterior"),
        (party_set_slot,":castle_no", slot_town_castle, "scn_castle_berber_interior"),
        (party_set_slot,":castle_no", slot_town_prison, "scn_castle_berber_prison"),
    (else_try),
        (party_slot_eq, ":castle_no", slot_center_culture, "fac_culture_garamantian"),
        (party_set_slot,":castle_no", slot_town_center, "scn_castle_garamantian_exterior"),
        (party_set_slot,":castle_no", slot_town_castle, "scn_castle_garamantian_interior"),
        (party_set_slot,":castle_no", slot_town_prison, "scn_castle_garamantian_prison"),
    (try_end),
    ...
    (try_for_range, ":village_no", villages_begin, villages_end),
        ...
        #     (party_slot_eq, ":village_no", slot_center_culture, "fac_culture_celtic"),
        #     (party_get_position,pos1,":village_no"),
        #     (map_get_water_position_around_position, pos2, pos1, 2),
        #     (party_set_position, "p_salt_mine", pos2),
        #     (store_distance_to_party_from_party, ":distance", "p_salt_mine", ":village_no"),
        ...
        #     (this_or_next|party_slot_eq, ":village_no", slot_center_culture, "fac_culture_roman"),
    ...
    (try_for_range, ":village_no", villages_begin, villages_end),#finally set all unassigned scenes yet
        ...
        (else_try),
            (party_slot_eq, ":village_no", slot_center_culture, "fac_culture_garamantian"),
            (party_set_slot,":village_no", slot_town_center, "scn_village_garamantian_2"),
        (else_try),
            (party_slot_eq, ":village_no", slot_center_culture, "fac_culture_berber"),
            (party_set_slot,":village_no", slot_town_center, "scn_village_berber"),
...
("game_event_party_encounter",[
    ...
    (else_try),
        ...
        (try_begin),
            ...
            (else_try),
                (this_or_next|eq, "$g_encountered_party_template", "pt_hord_roxolanen"),
                (eq, "$g_encountered_party_template", "pt_hord_siraken"),
            ...
            (else_try),
                (eq, "$g_encountered_party", "p_hanging_gardens"),
                (jump_to_menu, "mnu_hanging_gardens"),
            (else_try),
...
("game_event_simulate_battle",[
    ...
    (else_try),
        ...
        (try_begin),##I make judeans more powerful to withstand Roman attacks better#
            ...
            (faction_slot_eq, ":defender_faction", slot_faction_culture, "fac_culture_judean"),
        ...
        (try_begin),##I make judeans more powerful to withstand Roman attacks better
            ...
            (faction_slot_eq, ":attacker_faction", slot_faction_culture, "fac_culture_judean"),
        ...
        (try_begin),
            ...
            (try_begin),#check if the faction surrenders as puppet state
                ...
                # (try_begin),
                #     (this_or_next|faction_slot_eq, ":defeated_faction", slot_faction_culture, "fac_culture_dacian"),
                #     (this_or_next|faction_slot_eq, ":defeated_faction", slot_faction_culture, "fac_culture_celtic"),
                #     (this_or_next|faction_slot_eq, ":defeated_faction", slot_faction_culture, "fac_culture_sarmatian"),
                #     (faction_slot_eq, ":defeated_faction", slot_faction_culture, "fac_culture_germanic"),
    ...
    (else_try),#lords and stuff
        (try_begin),
            ...
            (try_begin),
                ...
                (else_try),
                    (this_or_next|troop_slot_eq, ":troop_no", slot_troop_culture, "fac_culture_germanic"),
                    (this_or_next|troop_slot_eq, ":troop_no", slot_troop_culture, "fac_culture_sarmatian"),
                    (this_or_next|troop_slot_eq, ":troop_no", slot_troop_culture, "fac_culture_dacian"),
                    (this_or_next|troop_slot_eq, ":troop_no", slot_troop_culture, "fac_culture_caledonian"),
                    (troop_slot_eq, ":troop_no", slot_troop_culture, "fac_culture_celtic"),
                    (str_store_string, s27, "@chieftain"),
                (else_try),
                    (this_or_next|troop_slot_eq, ":troop_no", slot_troop_culture, "fac_culture_syrian"),
                    (this_or_next|troop_slot_eq, ":troop_no", slot_troop_culture, "fac_culture_caucasian"),
                    (troop_slot_eq, ":troop_no", slot_troop_culture, "fac_culture_parthian"),
            ...
            (try_begin),
                ...
                (else_try),
                    (store_add, reg0, ":legion", ip_legio_1 - 1),
                    (str_store_info_page_name_link, s28, reg0),
                (try_end),
                ...
                (try_begin),
                    (str_is_empty, s29),
                    (str_store_string, s29, "str_dplmc_none"),
                (try_end),
...
("game_get_center_note",[
    ...
    (try_begin),
        (eq, ":note_index", 0),
        (eq, ":center_no", "p_pyramids"),
        (str_store_string, s0, "str_note_pyramids"),
        (set_trigger_result, 1),
    (else_try),
        (eq, ":note_index", 0),
        (eq, ":center_no", "p_olympia"),
        (quest_get_slot, reg24, "qst_olympic_games", slot_quest_dont_give_again_remaining_days),
        (try_begin),
            (gt, reg24, 0),
            (str_store_string, s0, "str_note_olympia_inactive"),
        (else_try),
            (str_store_string, s0, "str_note_olympia_active"),
        (try_end),
        (set_trigger_result, 1),
    (else_try),
        (eq, ":note_index", 0),
        (eq, ":center_no", "p_tarquinii"),
        (str_store_string, s0, "str_note_tarquinii"),
        (set_trigger_result, 1),
    (else_try),
        (eq, ":note_index", 0),
        (eq, ":center_no", "p_royal_tombs"),
        (str_store_string, s0,"str_note_aigai_tombs"),
        (set_trigger_result, 1),
    (else_try),
        (eq, ":note_index", 0),
        (eq, ":center_no", "p_delphi"),
        (str_store_string, s0,"str_note_delphi"),
        (set_trigger_result, 1),
    (else_try),
        (eq, ":note_index", 0),
        (eq, ":center_no", "p_hanging_gardens"),
        (str_store_string, s0,"str_note_hanging_gardens"),
        (set_trigger_result, 1),
    (else_try),
        (eq, ":note_index", 0),
        (is_between, ":center_no", "p_german_temple_1", "p_end_temple"),
        (store_sub, ":string_index", ":center_no", "p_german_temple_1"),
        (val_add, ":string_index", "str_holy_side_desc_german_temple_1"),
...
("game_get_faction_note",[
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (try_begin),
                    ...
                    (try_end),
                (try_end),
                (try_for_range, ":neighbors", kingdoms_begin, kingdoms_end),
                    (faction_slot_eq, ":neighbors", slot_faction_state, sfs_active),
                    (store_add, ":slot", slot_faction_neighbors_begin, ":neighbors"),
                    (val_sub, ":slot", kingdoms_begin),
                    (faction_get_slot, ":two_factions_share_border", ":faction_no", ":slot"),
                    (ge, ":two_factions_share_border", 1),
                    (str_store_faction_name, s2, ":faction_no"),
                    (str_store_faction_name_link, s3, ":neighbors"),
                    (str_store_string, s0, "@{s0}^{s2} neighbors of {s3}"),
                (try_end),
            (try_end),
            (set_trigger_result, 1),
        (try_end),
    ...
    (else_try),
        ...
        (str_store_string, s48, ":string"),
        (str_store_string, s0, "@{s0}^{s48}^^Foreign relations:"),

        (str_clear, s48),
        (try_for_range, ":cur_faction", kingdoms_begin, kingdoms_end),
            (faction_slot_eq, ":cur_faction", slot_faction_state, sfs_active),

            (store_relation, reg33, ":cur_faction", ":faction_no"),
            (str_store_faction_name_link, s49, ":cur_faction"),

            (str_clear, s48),
            (try_begin),
                (eq, ":cur_faction", "fac_player_supporters_faction"),
                (faction_slot_eq, ":faction_no", slot_faction_player_tributary, 1),
                (try_begin),
                    (neg|faction_slot_eq, ":cur_faction", slot_faction_leader, "trp_player"),
                    (str_store_string, s49, "str_you"),
                (try_end),
                (str_store_string, s48, "@They are tributary of {s49}."),
            (else_try),
                (eq, ":cur_faction", "fac_player_supporters_faction"),
                (lt, reg33, 0),
                (str_store_string, s48, "@They are hostile towards you."),
            (else_try),
                (eq, ":cur_faction", "fac_player_supporters_faction"),
                (gt, reg33, 0),
                (str_store_string, s48, "@They are friendly towards you."),
            (else_try),
                (lt, reg33, 0),
                (str_store_string, s48, "@{s49} is hostile towards them."),
            (else_try),
                (gt, reg33, 0),
                (str_store_string, s48, "@{s49} is friendly towards them."),
            (try_end),

            (try_begin),
                (neg|str_is_empty, s48),
...
("game_get_info_page_note",[
    ...
    (else_try),
        ...
        (try_for_range, ":province", p_hisp_tarraco, p_provinces_end),
            (assign, ":count", 0),
            (str_store_string, s9, "str_dplmc_none"),
            (try_for_range, ":walled_center", walled_centers_begin, walled_centers_end),
                (party_slot_eq, ":walled_center", slot_center_province, ":province"),
    ...
    (else_try),
        ...
        (try_for_range, ":companions", companions_begin, companions_end),
            ...
            (troop_get_slot, ":like_1", ":companions", slot_troop_personalitymatch_object),
            (try_begin),
                (is_between, ":like_1", companions_begin, companions_end),
                (str_store_troop_name_link, s4, ":like_1"),
                (str_store_string, s0, "@{s0}^     +) Likes {s4}"),
            (try_end),
            (try_begin),
                (is_between, ":hate_1", companions_begin, companions_end),
                (str_store_troop_name_link, s4, ":hate_1"),
                (str_store_string, s0, "@{s0}^     -) Hates {s4}"),
            (try_end),
            (try_begin),
                (is_between, ":hate_2", companions_begin, companions_end),
                (str_store_troop_name_link, s4, ":hate_2"),
                (str_store_string, s0, "@{s0}^     -) Hates {s4}"),
            (try_end),
        (try_end),
        (set_trigger_result, 1),
    (else_try),
        (eq, ":note_index", 0),
        (is_between, ":info_page_no", ip_legio_1, ip_legio_12+1),
        (try_for_range, ":legion", 1, 13),
            (store_add, ":legion_page", ":legion", ip_legio_1 - 1),
            (eq, ":info_page_no", ":legion_page"),
            # get legion commander
            (store_add, ":legion_commander", slot_legion_commanders_begin, ":legion"),
            (troop_get_slot, ":commander", "trp_province_array", ":legion_commander"),
            # add legion banner
            (try_begin),
                (str_clear, s0),
                (try_begin),
                    (ge, "$cheat_mode", 1),
                    (assign, reg10, ":legion"),
                    (str_store_string, s0, "@{s0}^^DEBUG INFO - Legioindex: {reg10}^^"),
                (try_end),
                (str_store_troop_name_link, s29, ":commander"),
                (str_store_string, s0, "@{s0}^^The legion is commanded by {s29}."),
                (try_begin),
                    (call_script, "script_get_troop_headquarter", ":commander"),
                    (is_between, reg0, walled_centers_begin, walled_centers_end),
                    (str_store_party_name_link, s10, reg0),
                    (str_store_string, s0, "@{s0} The headquarters are in {s10}."),
                (try_end),
                (str_store_string, s0, "@{s0}^^The legion has the following auxiliar units attached:"),
                ...
                (store_add, ":string_desc", "str_description_legio_begin", ":legion"),
                (str_store_string, s10, ":string_desc"),
                (str_store_string, s0, "@{s0}^^^Historical background:^^{s10}"),
...
("game_get_party_prisoner_limit",[
    ...
    #     (str_store_party_name, s12, ":party_id"),
    #     (display_message, "@Calculating prisoner limit for party: {s12}."),
    # (else_try),
    #     (display_message, "@Calculating prisoner limit for inactive party."),
    # (try_end),

    # (try_begin),
    #     (this_or_next|is_between, ":party_id", centers_begin, centers_end),
    ...
    #     # check for imprisoned lord and update the slot slot_troop_prisoner_of_party
    #     (call_script, "script_update_prisoner_slot", ":party_id"),
    # (try_end),
...
("game_get_item_extra_text",[
    ...
    (else_try),
        ...
        (try_begin),
            (eq, ":extra_text_id", 0),
            (store_sub, ":offset", ":item_no", books_begin),
            (val_add, ":offset", "str_book_desc_tactics"),
            ...
            (try_begin),
                ...
                (str_store_string, s2, "@^^Reading Progress: {reg1}%"),
            (try_end),
            (item_get_slot, reg1, ":item_no", slot_item_intelligence_requirement),
            (set_result_string, "@{s1}{s2}^^Requires {reg1} intelligence"),
            (set_trigger_result, 0xFFEEDD),
        (try_end),
    (else_try),
...
("game_context_menu_get_buttons",[
    ...
    (try_end),
    (try_begin),
        (this_or_next|eq, ":party_no", "p_tarquinii"),
        (this_or_next|eq, ":party_no", "p_royal_tombs"),
        (this_or_next|eq, ":party_no", "p_pyramids"),
        (this_or_next|eq, ":party_no", "p_olympia"),
        (this_or_next|eq, ":party_no", "p_delphi"),
        (this_or_next|eq, ":party_no", "p_hanging_gardens"),
        (this_or_next|is_between, ":party_no", "p_german_temple_1", "p_end_temple"),
...
("game_event_context_menu_button_clicked",[
    ...
    (else_try),
        ...
        (try_begin),
            (assign, ":block", walled_centers_end),
            (try_for_range, ":curr_town", walled_centers_begin, ":block"),#avoid landing points next to ports
            ...
            (try_end),
            (eq, ":block", -1),
            (display_message, "@Too close to a port.", message_negative),
        (else_try),
...
("update_prisoner_slot",[
    (store_script_param, ":party_id", 1),
    (party_get_num_prisoner_stacks, ":num_stacks",":party_id"),
    (try_for_range, ":stack_no", 0, ":num_stacks"),
        (party_prisoner_stack_get_troop_id, ":stack_troop",":party_id",":stack_no"),
        (troop_is_hero, ":stack_troop"),
        (is_between, ":stack_troop", active_npcs_begin, active_npcs_end),
        (troop_get_slot, ":imprisoned_in_party", ":stack_troop", slot_troop_prisoner_of_party),
        (neq, ":imprisoned_in_party", ":party_id"),
        (troop_set_slot, ":stack_troop", slot_troop_prisoner_of_party, ":party_id"),
        (try_begin),
            (party_is_active, ":imprisoned_in_party"),
            (str_store_party_name, s12, ":imprisoned_in_party"),
            (str_store_troop_name_link, s11, ":stack_troop"),
            (str_store_party_name, s13, ":party_id"),
            (display_message, "@{s11} was moved from prison in {s12} to {s13}."),
        (else_try),
            (str_store_troop_name_link, s11, ":stack_troop"),
            (str_store_party_name, s13, ":party_id"),
            (display_message, "@{s11} was moved to {s13} from an unknown location."),
        (try_end),
    (try_end),
]),
]#end of file
