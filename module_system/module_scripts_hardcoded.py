        ...
        (try_begin), #on water
            ...
            (try_begin), #but no ship
                ...
                # (try_begin),
                    ...
                    # # (display_message, "@Relocated player: reason: on water without ship"),
                    # (try_end),
                    # (try_for_range, ":cur_ferry_station", "p_ferry_1a", "p_transporter"),	#use ferry
