        ...
        (try_begin),#freelancing quest, promotion and payement
            ...
            (try_begin),
                ...
                (try_begin),
                    ...
                    (try_begin),
                        (neg|quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 6),
                        (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_state, 19),
                        (assign, ":continue", 1),
                    (else_try),
                        (neg|quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 5),
                        (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_state, 17),
                        (assign, ":continue", 1),
                    (else_try),
                        (neg|quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 4),
                        (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_state, 15),
                        (assign, ":continue", 1),
                    (else_try),
                        (neg|quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                        (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_state, 14),
                        (assign, ":continue", 1),
                    (else_try),
                        (neg|quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 2),
                        (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_state, 8),
                        (assign, ":continue", 1),
                    (else_try),
                        (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_state, 4),
                        (assign, ":continue", 1),
                    (try_end),
                (try_end),
                (try_begin),
...
(48,[
    ...
    (try_begin),
        ...
        (call_script, "script_freelancer_get_event", ":service_length"),
        (neq, reg20, -1),
        (jump_to_menu, reg20),
    (try_end),
