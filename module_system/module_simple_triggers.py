...
(0,[
    ...
    (else_try),
        ...
        (else_try),
            ...
            (jump_to_menu, "mnu_destory_fortifications"),
        (else_try),
            (ge,"$g_camp_mode", 1),
...
(335,[
    ...
    (try_begin),
        ...
        (val_add, ":chance", 60),
        (try_begin),
            (troop_slot_eq, ":spouse", slot_lord_reputation_type, lrep_hedonistic),
            (val_add, ":chance", 40),
        (try_end),
...
(24,[
    ...
    (try_begin),
        ...
        (quest_slot_eq, "qst_ludi_romani", slot_quest_dont_give_again_remaining_days, 0),
        (eq, "$g_cur_month", 9),
    ...
    (else_try),
        ...
        (neg|check_quest_active, "qst_saturnalia"),
        (neg|check_quest_active, "qst_ludi_romani"),
        (quest_slot_eq, "qst_saturnalia", slot_quest_dont_give_again_remaining_days, 0),
        (eq, "$g_cur_month", 12),
    ...
    (try_for_range,":troop",kingdom_ladies_begin, kingdom_ladies_end),
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (else_try),
                    (this_or_next|troop_slot_eq, "$g_talk_troop", slot_lord_reputation_type, lrep_hedonistic),
                ...
                (try_end),
                (display_message, "str_s33"),
                (try_begin),
                    (eq, "$g_infinite_camping", 0),
                    (tutorial_box, "str_s33", "@You recieve a letter"),
                (try_end),
            ...
            (else_try),
                ...
                (try_begin),
                    ...
                    (try_begin),
                        (eq, "$g_infinite_camping", 0),
                        (tutorial_box, "str_s33", "str_rumors"),
                    (try_end),
                (else_try),
                    (eq, ":amount", 200),
                    (store_random_in_range, ":random", 0,100),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (eq, "$g_infinite_camping", 0),
                (eq, "$g_display_gift", 1),
                (tutorial_box, "@It is well known that {s32} dislikes {s31}. Now you hear people say that {s31} has brought beautiful jewellry as present for {s32}.", "str_rumors"),
            (try_end),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (try_begin),
                    (eq, "$g_infinite_camping", 0),
                    (tutorial_box, "@You hear that {s31} gave a speech in {s30}. In his speech he said that you are a dishonerable man, not more worth then a beggar! He also said that you abuse your office and do many other crimes. The people of {s30} believed him! Your relationship with {s30} is hurt!", "str_rumors"),
                (try_end),
            (else_try),
                (str_store_party_name, s30, ":town_fond"),
                (str_store_troop_name, s31, ":actor"),
                (try_begin),
                    (eq, "$g_infinite_camping", 0),
                    (tutorial_box, "@You hear that {s31} gave a speech in {s30}. In his speech he said that you are a dishonerable man, not more worth then a beggar! He also said that you abuse your office and do many other crimes. His speech was a disaster! The people of {s30} throw him out of the city!", "str_rumors"),
                (try_end),
            (try_end),
        (else_try),
            (store_random_in_range, ":action", 0, 110),#make it less often
            ...
            (try_begin),
                ...
                (try_begin),
                    (eq, "$g_infinite_camping", 0),
                    (tutorial_box, "@You hear that {s31} gave a speech before the senate. In his speech he said that you are a dishonerable man, not more worth then a beggar! He also said that you abuse your office and do many other crimes. Some senators stopped supporting you.", "str_rumors"),
                (try_end),
            (else_try),
                (str_store_troop_name, s31, ":actor"),
                (try_begin),
                    (eq, "$g_infinite_camping", 0),
                    (tutorial_box, "@You hear that {s31} gave a speech before the senate. In his speech he said that you are a dishonerable man, not more worth then a beggar! He also said that you abuse your office and do many other crimes. His speech has not effected the opinion of the senators.", "str_rumors"),
                (try_end),
            (try_end),
        (try_end),
    (try_end),
...
(0.27, [
    ...
    (try_begin),
        ...
        (try_begin),
            (lt, ":randomnum", ":chance"),
            (dialog_box, "@It is said that {s44} has tortured {s45} and most people believe the stories.", "str_rumors"),
        ...
        (else_try),
            (dialog_box, "@Some people say that {s44} has tortured {s45}, but most people think this is only enemy gossip.", "str_rumors"),
...
(0,[
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (assign, ":new_icon", "icon_generic_slave_donkey"),
        (else_try),
            (neg|troop_slot_ge, "trp_player", slot_troop_renown, 50),
            (assign, ":new_icon", "icon_generic_slave"),
        (else_try),
            (party_slot_eq, "p_town_6", slot_town_lord, "trp_player"),
            (troop_slot_eq, "trp_player", slot_troop_culture, "fac_culture_roman"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_roman_praetorian_cav"),
            (else_try),
                (assign, ":new_icon", "icon_roman_vexilarius"),
            (try_end),
        (else_try),
            (this_or_next|faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_caledonian"),
            (faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_celtic"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_celtic_noble"),
            (else_try),
                (assign, ":new_icon", "icon_british_foot"),
            (try_end),
        (else_try),
            (faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_germanic"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_germanic_cavalry"),
            (else_try),
                (assign, ":new_icon", "icon_germanic_noble"),
            (try_end),
        (else_try),
            (faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_judean"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_judean_noble"),
            (else_try),
                (assign, ":new_icon", "icon_generic_mercenary_inf"),
            (try_end),
        (else_try),
            (faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_parthian"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_eastern_cataphract"),
            (else_try),
                (assign, ":new_icon", "icon_eastern_archer"),
            (try_end),
        (else_try),
            (this_or_next|faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_caucasian"),
            (faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_syrian"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_eastern_noble"),
            (else_try),
                (assign, ":new_icon", "icon_eastern_archer"),
            (try_end),
        (else_try),
            (faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_egyptian"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_eastern_noble"),
            (else_try),
        ...
        (else_try),
            ...
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_dacian_noble"),
            (else_try),
                (assign, ":new_icon", "icon_dacian_foot"),
            (try_end),
        (else_try),
            (faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_greek"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_roman_legate"),
            (else_try),
                (assign, ":new_icon", "icon_generic_mercenary_inf"),
            (try_end),
        (else_try),
            ...
            (else_try),
                ...
                (try_begin),
                    (ge, ":cur_horse", 0),
                    (assign, ":new_icon", "icon_roman_aux_cavalry"),
                (else_try),
                    (assign, ":new_icon", "icon_roman_aux_inf"),
                (try_end),
            (else_try),
                (assign, ":new_icon", "icon_roman_legate"),
            (try_end),
        (else_try),
            (faction_slot_eq, "$players_kingdom", slot_faction_culture, "fac_culture_bosporan"),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_sarmatian_cavalry"),
            (else_try),
                (assign, ":new_icon", "icon_bosporan_foot"),
            (try_end),
        (else_try),
            ...
            (try_begin),
                ...
                (assign, ":new_icon", "icon_sarmatian_cavalry"),
            (else_try),
                (assign, ":new_icon", "icon_sarmatian_foot"),
            (try_end),
        (else_try),
            (try_begin),
                (ge, ":cur_horse", 0),
                (assign, ":new_icon", "icon_generic_celitc_cav"),
            (else_try),
                (assign, ":new_icon", "icon_generic_mercenary_inf"),
            (try_end),
        (try_end),
...
(72.0/(number_of_walled_centers),[
    ...
    (party_get_slot, ":mercenaries", ":walled_center", slot_center_mercenary_troop_amount_2),
    (try_begin),
        (gt, ":mercenaries", ":mercenaries_limit"),
        (store_random_in_range, ":change", 1, 3),##more negative effects now possible
        (val_mul, ":change", -1),
        (val_add, ":mercenaries", ":change"),
        (party_set_slot, ":walled_center", slot_center_mercenary_troop_amount_2, ":mercenaries"),
    (else_try),
        (lt, ":mercenaries", ":mercenaries_limit"),
        (store_random_in_range, ":change", 2, 5),
        (try_begin),
            (party_slot_ge, ":walled_center", slot_center_has_training_grounds, 1),
            (val_mul, ":change", 2),
        (try_end),
        ...
        (try_for_range, ":building", slot_lat_silk, slot_lat_building_end),
            ...
            (else_try),
                ...
                (try_begin),
                    ...
                    (faction_get_slot, ":low_tier_troop", ":culture", slot_faction_tier_1_troop),
                    (party_force_add_members, ":latifundium", ":low_tier_troop", 10),
                (else_try),
...
(8,[
    ...
    (try_for_parties, ":party_no"),
        ...
        (try_begin),
            ...
            (party_slot_eq, ":party_no", slot_party_ai_object, ":cur_attached_town"),
            ...
            # (str_store_string, s1, ":party_no"),
            # (display_message, "@{s1} reached target"),
        (else_try),
            (party_is_active, ":cur_attached_town"),
            (party_detach, ":party_no"),
        (try_end),
    (try_end),
]),
    ...
    (try_for_parties, ":party_no"),
        ...
        (try_for_range_backwards, ":stack_no", 0, ":num_stacks"),
            ...
            (try_begin), #routed parties sometimes contain extraneous units, players may also give random stuff to reinforcements
                ...
                (this_or_next|is_between, ":faction_no", "fac_roman_rebells", "fac_nasamones"),
...
(24, [
    ...
    (try_for_range, ":cur_quest", all_quests_begin, all_quests_end),
        ...
        # fail quest if quest giver died
        (quest_get_slot, ":quest_giver", ":cur_quest", slot_quest_giver_troop),
        (try_begin),
            (is_between, ":quest_giver", active_npcs_begin, active_npcs_end),
            (troop_slot_eq, ":quest_giver", slot_troop_occupation, dplmc_slto_dead),
            (str_store_troop_name_link, s13, ":quest_giver"),
            (display_message, "@Quest expired as {s13} deceased.", message_negative),
            (call_script, "script_abort_quest", ":cur_quest", 0),
        (try_end),
        ...
        (try_begin),
            ...
            (val_sub, ":exp_days", 1),
            (try_begin),
                (eq, ":cur_quest", "qst_conspiracy"),
                (eq, ":exp_days", 0),
                (call_script, "script_fail_quest", ":cur_quest"),
                (call_script, "script_end_quest", ":cur_quest"),
                (display_message, "@You have failed to properly investigate the conspiracy against you.", color_bad_news),
    ...
    (try_begin),
        ...
        (try_begin),##events if you are famous
            ...
            (else_try),
                ...
                (this_or_next|eq, ":terrain", rt_desert),
                (eq, ":terrain", rt_desert_forest),
                (jump_to_menu,"mnu_event_desert_dates"),
            (else_try),
                (eq, "$g_is_emperor", 1),
...
(50,[
    ...
    (neq, ":fac", "fac_kingdom_17"),
    (neq, "$jewish_revolt", 1),
    (assign, ":revolt_chance", 8),
    (try_begin),
        (eq, "$edict5", 2),
        (assign, ":revolt_chance", 2),
    (try_end),
    (party_get_slot, ":lord", "p_town_19", slot_town_lord),
    (ge, ":lord", 1),
...
(4.0*24.0/(number_of_walled_centers),[
    ...
    (try_begin),
        ...
        (store_faction_of_party, ":faction", ":center"),
        (call_script, "script_cf_select_random_walled_center_with_faction", ":faction", -1),
        (assign, ":target_port_town", reg0),
        (is_between,":target_port_town",walled_centers_begin, walled_centers_end),
        (neq, ":target_port_town", ":center"),
        (party_slot_eq, ":target_port_town", slot_center_is_besieged_by, -1),
        ...
        # (str_store_party_name, s2, ":target_port_town"),
        # (display_message, "@Slave trader created at {s1}, target: {s2}."),
    ...
    (try_begin),
        ...
        # (str_store_party_name, s1, ":center"),
        # (str_store_party_name, s2, ":target_port_town"),
        # (display_message, "@Traveler created at {s1}, target: {s2}."),
...
(275,[
    ...
    (try_begin),
        ...
        (store_random_in_range, ":r", 0, 100),
        (lt, ":r", 40),
        (display_message, "@It hurts Fortuna how dishounorable you are.", color_bad_news),
    ...
    (else_try),
        ...
        (store_random_in_range, ":r", 0, 100),
        (lt, ":r", 40),
        (display_message, "@Fortuna is pleased seeing you being a hounorable man.", color_good_news),
        (troop_get_slot, ":relation", "trp_fortuna", slot_troop_player_relation),
        (val_add, ":relation", 1),
        (troop_set_slot, "trp_fortuna", slot_troop_player_relation, ":relation"),
    (try_end),
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (try_begin),
                    ...
                    (dialog_box, "@Rumors say that {s44} has evaded taxes of {s40}.", "str_rumors"),
                (else_try),
...
(24.0*7.0/(number_of_villages),[
    ...
    (try_begin),#pigbacking
        ...
        (else_try),
            (party_slot_eq, ":village", slot_center_province, p_afrc_cyre),
            (assign, ":nomad_faction", "fac_nasamones"),
        (else_try),
            (party_slot_eq, ":village", slot_center_province, p_afrc_maur),
            (assign, ":nomad_faction", "fac_baquates"),
        (else_try),
...
(24,[
    ...
    (try_begin),
        (neg|str_is_empty, s1),
        (tutorial_box, "str_s1", "@Wound Report"),
    (try_end),
]),
...
(24,[
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (else_try),
                    ...
                    (val_div, ":player_renown", 2),
                (else_try),
                    (this_or_next|eq, ":lady_reputation", lrep_hedonistic),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (party_force_add_members, "p_main_party", "trp_garamantian_horseman_merc", 200),
            (party_force_add_members, "p_main_party", "trp_garamantian_noble_horseman_merc", 100),
        (else_try),
            (eq, ":val", 0),
            #(neq, "$g_player_is_captive", 1),
    ...
    (try_end),
    (try_for_range, ":female_slave", follower_troops_begin, follower_troops_end),
...
(24 * 7,[
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (neq, ":terrain", rt_desert),
            (neq, ":terrain", rt_desert_forest),
            (display_message, "@Winter is the worst time for war. It's cold, it rains too much and food is scarce. In winter, men would rather shelter by the fire than campaign. Watch your morale and your food stores.", color_bad_news),
            (call_script, "script_change_player_party_morale", -5),
        (else_try),#deserts also have penalty
            (this_or_next|eq, ":terrain", rt_desert_forest),
            (eq, ":terrain", rt_desert),
            (display_message, "@Deserts are relentless places. The heat is unbearable and water is always scarce.", color_bad_news),
            (call_script, "script_change_player_party_morale", -10),
        (else_try),#seas also have penalty
            (this_or_next|eq, ":terrain", rt_water),
            (eq, ":terrain", rt_bridge),
            (display_message, "@Your men feel uneasy. They think the sea gods are in a bad mood.", color_bad_news),
            (call_script, "script_change_player_party_morale", -10),
        (try_end),
    (try_end),
]),
        ...
        # (else_try),##rebel ai+minor faction AI
            ...
            ##search for a target to raid
                ...
                (else_try),###West African Factions
                    (this_or_next|eq, ":faction", "fac_baquates"),
                    (eq, ":faction", "fac_nasamones"),
                    (try_begin),
...
(24*7,[
    ...
    (try_begin),
        ...
        (lt, ":r", 4),
        (assign, ":continue", 0),
        (assign, ":minister_troop", "$g_player_minister"),
        (try_begin),
            (le, ":minister_troop", 1),
            (troop_get_slot, ":minister_troop", "trp_player", slot_troop_spouse),
        (try_end),
        (gt, ":minister_troop", 1),
        (try_begin),
            (call_script, "script_troop_get_player_relation", ":minister_troop"),
            (le, reg0, -10),
            (assign, ":continue", 1),
        (else_try),
            (lt, "$player_honor", 0),
