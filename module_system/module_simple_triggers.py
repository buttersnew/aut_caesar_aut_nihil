...
(335,[
    ...
    (try_for_range, ":lady", kingdom_ladies_begin, kingdom_ladies_end),
        (try_begin),
            (troop_slot_ge, ":lady", slot_troop_lover_found, 1),
        ...
        (try_begin),###this shall randomly break love affairs
            ...
            (lt, ":rand", 10),
            (troop_set_slot, ":lady", slot_troop_lover, -1),
            (troop_set_slot, ":lady", slot_troop_player_knows, 0),
...
(24.0*7.0/(number_of_centers),[
    ...
    (try_begin),
        ...
        (call_script, "script_assign_center_to_lord", "$g_center_trigger_taxes"),
        ...
        (try_begin),##disaster event
            ...
            # (party_slot_eq, "$g_center_trigger_taxes", slot_center_event, event_insects),#this event is only for villages
            (store_random_in_range, ":r", 0, 301),#low probability
            (eq, ":r", 0),
            (assign, "$temp1", "$g_center_trigger_taxes"),
        ...
        (try_begin),##for the latifundium
            ...
            (party_get_slot, ":latifundium", "$g_center_trigger_taxes", slot_center_has_latifundium),
            (ge, ":latifundium", 1),
            (try_begin),
                (neg|party_is_active, ":latifundium"),##if party is not vaild display error
                (str_store_party_name, s29, "$g_center_trigger_taxes"),
            ...
            # (else_try),
            # (neg|party_slot_ge, ":latifundium", slot_lat_guards, 1),
            # (party_slot_eq, "$g_center_trigger_taxes", slot_village_state, svs_looted),
            # (display_message, "@{s60} has been looted, you wont recieve taxes from your latifundium there."),
            # (else_try),
            (call_script, "script_calculate_latifundium_rents", ":latifundium", "$g_center_trigger_taxes"),
            (try_begin),###fire events
                ...
                (try_begin),
                    ...
                    (try_begin),
                        ...
                        (assign, "$temp2", "$g_center_trigger_taxes"),
    ...
    ##TAXES FOR THE PLAYER BEGIN
                ...
                (try_begin),
                    ...
                    (try_begin),
                        ...
                        (else_try),
                            ...
                            (store_random_in_range, ":random",0, ":player_level"),
                            (party_add_members, "$g_center_trigger_taxes", "trp_mercenary_crossbowman", ":random"),
                        (try_end),
                    (try_end),
                (try_end),
            (try_end),
      ##TAX FOR PLAYER ENDS ##TAX FOR PLAYER ENDS
            ...
            (try_begin),
                (this_or_next|party_slot_eq, "$g_center_trigger_taxes", slot_party_type, spt_town),
                (party_slot_eq, "$g_center_trigger_taxes", slot_party_type, spt_castle),
                (store_faction_of_party, ":fac", "$g_center_trigger_taxes"),
                (faction_slot_eq, ":fac", slot_faction_government_type, gov_imperial),
                (call_script, "script_calculate_bureaucratic_costs", "$g_center_trigger_taxes", 1),
            (try_end),
...
(8,[
    ...
    (try_for_parties, ":party_no"),
        ...
        (else_try), ## SEA TRADE
            ...
            (try_begin),
                (ge, "$cheat_mode", 1),
                (str_store_party_name, s10, ":object_town"),
                (display_message, "@object ist {s10}"),
            (try_end),
            ...
            (else_try),
                ...
                (try_begin),
                    (eq, ":do_trade", 1),
                    (str_store_party_name, s7, ":cur_center"),
                    #(display_message, "@Doing now trade in {s7}"),
                    (call_script, "script_do_merchant_town_trade", ":party_no", ":cur_center"),
                    ##drop of prisoners
                    (call_script, "script_party_add_party_prisoners", ":cur_center", ":party_no"),
                    (call_script, "script_party_remove_all_prisoners", ":party_no"),
...
(72.0/(number_of_walled_centers),[
    ...
    (call_script, "script_update_volunteer_troops_in_castle_town", ":walled_center"),
]),
    ...
    (try_for_range_backwards, ":i_stack", 0, ":num_stacks"),    #MOTO go from bottom of stack (which player can easily manipulate)
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (store_mul, ":addition", "$g_constable_training_improved", 2),
                (val_add, ":xp_gain", ":addition"), #more recruits are trained during improved training
            (try_end),
...
(24.0*2.0/(number_of_towns),[
    ...
    (try_end),
    (eq, ":patrol", 0),
    (party_get_slot, ":wealth", ":center", slot_town_wealth),
    (ge, ":wealth", 6000),
    (try_begin),
        (ge, ":wealth", 18000),
        (assign, ":size", 2),
    ...
    (else_try),
        ...
        (assign, ":size", 0),
    (try_end),
    # (party_set_slot, ":center", slot_town_wealth, ":wealth"),
...
(24,[
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (display_message, "@Your last town was captured and you lost {reg0}/{reg1} of your treasury", message_negative),
        (try_end),
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 2),
                (jump_to_menu, "mnu_freelancer_event_1"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 3),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 8),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 3),
                (jump_to_menu, "mnu_freelancer_event_1_wine"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 4),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 14),
            ...
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 20),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 5),
                (jump_to_menu, "mnu_freelancer_event_2"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 6),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 26),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 6),
                (jump_to_menu, "mnu_freelancer_event_10"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 7),
            (else_try),
              # (is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 32),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 7),
                (jump_to_menu, "mnu_freelancer_event_3"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 8),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 37),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 8),
                (jump_to_menu, "mnu_freelancer_event_4"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 9),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 43),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 9),
                (jump_to_menu, "mnu_freelancer_event_5_1"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 10),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 45),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 10),
                (jump_to_menu, "mnu_freelancer_event_5"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 11),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 48),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 11),
                (jump_to_menu, "mnu_freelancer_event_6"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 12),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 53),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 12),
                (jump_to_menu, "mnu_freelancer_event_7"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 13),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 58),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 13),
                (jump_to_menu, "mnu_freelancer_event_8"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 14),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 63),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 14),
                (jump_to_menu, "mnu_freelancer_event_9"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 15),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 68),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 4),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 15),
                (jump_to_menu, "mnu_freelancer_event_13"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 16),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 73),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 5),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 16),
                (jump_to_menu, "mnu_freelancer_event_11"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 17),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 78),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 5),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 17),
                (jump_to_menu, "mnu_freelancer_event_14"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 18),
            (else_try),
                #(is_currently_night),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 83),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 6),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 18),
                (jump_to_menu, "mnu_freelancer_event_12"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 19),
            (else_try),#freelancer bonus event
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 90),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 6),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 19),
                (jump_to_menu, "mnu_freelancer_event_0"),
        ...
        (else_try),
            (try_begin),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 2),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 2),
                (jump_to_menu, "mnu_freelancer_event_pret_1"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 3),
            (else_try),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 3),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 7),
                (jump_to_menu, "mnu_freelancer_event_pret_2"),#octavia event 1
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 4),
            (else_try),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 4),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 12),
                (jump_to_menu, "mnu_freelancer_event_pret_3"),#octavia event 2
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 5),
            (else_try),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 5),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 17),
                (jump_to_menu, "mnu_freelancer_event_pret_4"),#octavia event 3
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 6),
            (else_try),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 6),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 22),
                (jump_to_menu, "mnu_freelancer_event_pret_5"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 7),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 7),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 27),
                (jump_to_menu, "mnu_freelancer_event_pret_6"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 8),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 8),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 32),
                (jump_to_menu, "mnu_freelancer_event_pret_7"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 9),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 9),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 37),
                (jump_to_menu, "mnu_freelancer_event_pret_8"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 10),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 3),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 10),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 42),
                (jump_to_menu, "mnu_freelancer_event_pret_9"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 11),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 4),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 11),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 47),
                (jump_to_menu, "mnu_freelancer_event_pret_10"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 12),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 5),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 12),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 52),
                (jump_to_menu, "mnu_freelancer_event_pret_11"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 13),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 5),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 13),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 57),
                (jump_to_menu, "mnu_freelancer_event_pret_12"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 14),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 5),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 14),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 62),
                (jump_to_menu, "mnu_freelancer_event_pret_13"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 15),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 5),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 15),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 67),
                (jump_to_menu, "mnu_freelancer_event_pret_14"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 16),
            (else_try),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_rank, 6),
                (quest_slot_eq, "qst_freelancing", slot_quest_freelancer_state, 16),
                (quest_slot_ge, "qst_freelancing", slot_quest_freelancer_service_length, 72),
                (jump_to_menu, "mnu_freelancer_event_pret_15"),
                (quest_set_slot, "qst_freelancing", slot_quest_freelancer_state, 17),
            (try_end),
        (try_end),
    (try_end),
...
(ti_on_switch_to_map, [
    ...
    ##fix latifundium not changing factions properly
        ...
        (else_try),
            (is_between, ":party_no", "p_temp_party", "p_vally_of_kings"),
...
(4.0*24.0/(number_of_walled_centers),[
    ...
    (try_begin),
        ...
        (try_begin),
            ...
            (assign, ":rebel_party", reg0),
            (try_begin),
                (le, ":rebel_party", "p_vally_of_kings"),
...
(50,[
    ...
    (try_begin),
        ...
        (store_random_in_range, ":r", 0, 6),#0,1,2,3,4,5
        (try_begin),
            (lt, ":r", 4),#0,1,2,3
...
(24,[
	...
	(try_for_range, ":troop", active_npcs_begin, active_npcs_end),
		...
		(try_begin),
			...
			(party_count_prisoners_of_type, ":slave_number", ":party", "trp_slave"),
			(party_count_prisoners_of_type, ":slave_number2", ":party", "trp_slave_female"),
			(party_remove_prisoners, ":party", "trp_slave", ":slave_number"),
			(party_remove_prisoners, ":party", "trp_slave_female", ":slave_number2"),
...
(1,[
    ...
    (try_for_range, ":slot", s_nabatean_parties_begin, s_rebell_parties_end),
...
(24,[
    ...
    (try_begin),
        ...
        (try_begin),
            (le, ":bandit_party", "p_vally_of_kings"),
    ...
    (try_for_range, ":slot", slot_legion_home_begin, slot_legion_home_end),
        ...
        (try_begin),
            ...
            (try_begin),
                ...
                (try_end),
            (else_try), # legate is dead find new one
    ...
    (try_for_range_backwards, ":province", slot_province_governor_begin, p_provinces_end),
        ...
        (try_begin),
            ...
            (else_try),
                ...
                (eq, "$g_lord_can_spawn_out_center", 1),
