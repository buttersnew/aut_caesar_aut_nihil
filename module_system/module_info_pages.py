...
+"^*) Player can modify time-flow by keeping control pressed an clicking one of the numpad-keys. This feature unfortunately only works with cheat-mode enabled."
