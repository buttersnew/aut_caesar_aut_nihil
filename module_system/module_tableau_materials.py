...
("civil_war_factions", 0, "tableau_with_transparency", 1024, 1024, 0, 0, 300, 300,[
    ...
    (try_begin),
        (try_begin),
            (faction_slot_eq, "fac_kingdom_24", slot_faction_state, sfs_active),
            (assign, ":fac", "fac_kingdom_24"),
        (else_try),
            (faction_slot_eq, "fac_player_supporters_faction", slot_faction_state, sfs_active),
            (faction_slot_eq, "fac_player_supporters_faction", slot_faction_leader, "trp_player"),
            (faction_slot_eq, "fac_player_supporters_faction", slot_faction_culture, "fac_culture_roman"),
            (assign, ":fac", "fac_player_supporters_faction"),
        (try_end),
        (faction_get_slot, ":leader_troop", ":fac", slot_faction_leader),
        (ge, ":leader_troop", 0),
        (troop_get_slot, ":banner_spr", ":leader_troop", slot_troop_banner_scene_prop),
        (store_add, ":banner_scene_props_end", banner_scene_props_end_minus_one, 1),
        (is_between, ":banner_spr", banner_scene_props_begin, ":banner_scene_props_end"),
    ...
    (try_begin),
        (try_begin),
            (faction_slot_eq, "fac_kingdom_26", slot_faction_state, sfs_active),
            (assign, ":fac", "fac_kingdom_26"),
        (else_try),
            (faction_slot_eq, "fac_player_supporters_faction", slot_faction_state, sfs_active),
            (faction_slot_eq, "fac_player_supporters_faction", slot_faction_leader, "trp_player"),
            (faction_slot_eq, "fac_player_supporters_faction", slot_faction_culture, "fac_culture_roman"),
