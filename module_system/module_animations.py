...
#  [35.0, "tavern_stand", 0, 472, arf_cyclic|arf_loop_pos_0_25],
 ...
 ["stand_man", 0, amf_client_prediction,
    [11.0, "new_stand_man", 0, 315, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    ...
    [65, "lord_stand_4", 0, 1400, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
    [60, "lord_stand_4", 1400, 2550, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
    [60, "lord_stand_4", 2550, 3601, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
   ],
...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
   ...
   # [6.0, "sword_loop02", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [7, "new_idle_shield", 0, 10, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
   [7, "sword_loop03", 0, 99, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
   [7, "sword_loop04", 0, 99, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
   [7, "sword_loop06", 0, 99, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
   [7, "sword_loop03_new", 0, 59, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
   [7, "sword_loop03_new2", 0, 59, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
 ],
...
#   [0.8, "run_normal", 0, 12, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)],
   # [0.8, "sa_run_forward_onehanded", 0, 25, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
...
##   [0.8, "anim_human", horse_move+210, horse_move+250, arf_cyclic |  arf_blend_in_16],
   ...
   [1.0, "newanim_ride_1", 0, 31, arf_cyclic],
   [1.0, "newanim_ride_2", 0, 31, arf_cyclic],
   [1.0, "newanim_ride_3", 0, 31, arf_cyclic],
   [1.0, "newanim_ride_4", 0, 31, arf_cyclic],
 ],
...
#   [0.3, "anim_human", combat+530, combat+532, arf_blend_in_2],
 ...
 ["ready_javelin", acf_rot_vertical_bow, amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.6, "throw_javelin2_kite", 0, 30, blend_in_ready],
 ],
 ["release_javelin", acf_rot_vertical_bow, amf_priority_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_throw,
   [0.9, "throw_javelin2_kite", 55, 100, arf_blend_in_0],
 ],
...
##   [0.3, "throw_axe", 0, 40, blend_in_ready],
   [0.6, "throw_boulder_overhead", 0, 26, blend_in_ready],
 ],
...
##   [0.9, "throw_axe", 40, 90, arf_blend_in_0],
   [0.9, "throw_boulder_overhead", 26, 72, arf_blend_in_0],
 ],
...
##   [ready_durn, "anim_human", combat+8500, combat+8510, blend_in_ready],
   ...
   [ready_durn, "attacks_thrust_onehanded_y3", 0, 15, blend_in_ready],
  ],
...
##   [0.61, "anim_human", combat+8510, combat+8540, blend_in_release],
   ...
   [0.45, "attacks_thrust_onehanded_y3", 15, 23, blend_in_release],
 ],
 ["release_thrust_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust|amf_client_owner_prediction,
   ...
   [0.19, "attacks_thrust_onehanded_y3", 23, 35, blend_in_continue],
 ],
...
##   [0.6, "attacks_single_righttoleft", 10, 26, blend_in_release],
   ...
   [0.6, "1h_slashright_13.9.10", 5, 30, blend_in_release],
 ],
...
["ready_overswing_onehanded", acf_overswing|acf_enforce_rightside|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_overswing,
...
##   [ready_durn, "attacks_single_overswing", 2, 16, blend_in_ready],
 ...
 ["release_overswing_onehanded", acf_overswing|acf_enforce_rightside|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_rider_rot_overswing|amf_continue_to_next,
...
#   [0.6, "thrust_staff", 93, 125, arf_blend_in_2],
   [0.45, "Polearm_thrust_3.10.10", 5, 32, blend_in_release],
 ],
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3],
 ...
 ["fall_chest_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [1.0, "new_death_7", 0, 199, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0.0), (0,0,0), 0.5],
   [1.0, "vyrn_chest", 0, 79, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0.0), (0,0,0), 0.5],
   [3.0, "new_death_9", 0, 60, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0.0), (0,0,0), 0.5],
 ...
 ["fall_right_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [1.9, "wounded_leg_right_fall", 0, 44, arf_blend_in_16|arf_make_custom_sound, pack2f(0.65, 0.0), (0,0,0), 1.0],
    [4.4, "death_generic3", 7, 110, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [3.6, "death_generic4", 0, 57, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [3.6, "death_generic4b", 0, 57, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [4.4, "death_generic3", 7, 110, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 1.4],
 ...
 ["fall_body_back", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [3.0, "my_death_7", 0, 96, arf_blend_in_16|arf_make_custom_sound, pack2f(0.47, 0.82), (0,0,0), 1.8],
   [2.7, "new_death_10", 0, 54, arf_blend_in_16|arf_make_custom_sound, pack2f(0.47, 0.82), (0,0,0), 1.8],
   [14, "new_death_11", 0, 249, arf_blend_in_16|arf_make_custom_sound, pack2f(0.47, 0.82), (0,0,0), 1.8],
     [4.4, "death_generic3", 7, 110, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [3.6, "death_generic4", 0, 57, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [3.6, "death_generic4b", 0, 57, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 2],
    [4.4, "death_generic3", 7, 110, arf_blend_in_16|arf_make_custom_sound, pack2f(0, 0.5), (0, 0, 0), 1.4],
...
##   [3.0, "anim_human", 70100, 70150, arf_blend_in_5],
   ...
   [1.8, "stand_victory_idle_a", 0, 34, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [3.2, "cifre_air_thrust1", 0, 113, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [4.1, "cifre_air_thrust2", 0, 146, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ...
 ["stand_lady", 0, 0,
   ...
   [29.0, "lady_stand_new_2", 0, 863, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [5.5, "lady_stand_new_3", 0, 144, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_lord", 0, 0,
   [11.0, "lord_stand", 0, 111, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [11.0, "lord_stand_2", 0, 115, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [9.5, "lord_stand_3", 0, 95, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [65, "lord_stand_4", 0, 1400, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
    [60, "lord_stand_4", 1400, 2550, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
    [60, "lord_stand_4", 2550, 3601, arf_cyclic|arf_use_stand_progress, 0, (0, 0, 0), 0.25],
 ],
...
# ],
 ["ready_overswing_musket", acf_overswing|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  ...
  [ready_durn, "attacks_thrust_overhead1", 1, 2, blend_in_ready],
 ],
 ["release_overswing_musket", acf_overswing|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
  ...
  [0.40, "attacks_thrust_overhead1", 1, 6, blend_in_release],
 ],
 ["release_overswing_musket_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  ...
  [0.20, "attacks_thrust_overhead1", 4, 1, blend_in_release],
 ],
 ["parried_overswing_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
  # [attack_parried_duration_thrust, "attacks_thrust_overhead2", 39, 21, arf_blend_in_2],
  [attack_parried_duration_thrust, "attacks_thrust_overhead1", 4, 1, arf_blend_in_2],
 ],
 ["blocked_overswing_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  # [attack_blocked_duration_thrust, "attacks_thrust_overhead2", 39, 21, arf_blend_in_2],
  [attack_blocked_duration_thrust, "attacks_thrust_overhead1", 4, 1, arf_blend_in_2],
 ],

 ["ready_thrust_musket", acf_overswing|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction,
  [ready_durn, "gladius_thrust", 0, 2, blend_in_ready],
  #[ready_durn, "attacks_thrust_overhead1", 1, 2, blend_in_ready],
 ],
 ["release_thrust_musket", acf_overswing|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next,
  [0.3, "gladius_thrust", 2, 7, blend_in_release],
  #[0.40, "attacks_thrust_overhead1", 1, 6, blend_in_release],
 ],
 ["release_thrust_musket_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
  [0.22, "gladius_thrust", 7, 10, blend_in_release],
  #[0.20, "attacks_thrust_overhead1", 4, 1, blend_in_release],
 ],
 ["parried_thrust_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
    [attack_parried_duration_thrust, "gladius_thrust", 3, 1, arf_blend_in_2],
   # [attack_parried_duration_thrust, "attacks_thrust_overhead1", 4, 1, arf_blend_in_2],
 ],
 ["blocked_thrust_musket", 0, amf_priority_blocked|amf_use_weapon_speed|amf_play,
  [attack_blocked_duration_thrust, "gladius_thrust", 3, 1, arf_blend_in_2],
 # [attack_blocked_duration_thrust, "attacks_thrust_overhead1", 4, 1, arf_blend_in_2],
 ],
 ...
 ["end_animation", acf_enforce_all, amf_priority_die|amf_play,
#   [3.0, "myanim", 0, 50, arf_cyclic|arf_loop_pos_0_25],
   [3.0, "anim_human", 50, 52, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [3.0, "anim_human", 60, 62, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.75],
   [3.0, "anim_human", 70, 72, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ...
 ["female_fucker_1", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "anim_human", 0, 9, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["female_fucker_2", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "anim_human", 0, 9, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["fuck_female", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "anim_human", 0, 8, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ...
 ["male_masterb", acf_enforce_all, amf_priority_die|amf_play,
	[0.3, "anim_human", 0, 4, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["fuck_female_blow", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "anim_human", 0, 8, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["female_cum", acf_enforce_all, amf_priority_die|amf_play,
	[0.6, "anim_human", 0, 9, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
 ["dance", acf_enforce_all, amf_priority_die|amf_play,
	[4.0, "dancer_1", 0, 23, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [3.0, "dancer_3", 0, 17, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [3.2, "dancer_4", 0, 18, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [3.2, "dancer_2", 0, 18, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [19, "belly_dancing", 5, 250, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [13, "belly_dancing", 575, 755, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    ],
 ["kissing_male", acf_enforce_all, amf_priority_die|amf_play,
   [9, "kissing_male", 0, 63, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["kissing_female", acf_enforce_all, amf_priority_die|amf_play,
   [9, "kissing_female", 0, 63, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ...
 ["vyrn_shieldmaiden_stand", acf_enforce_all, amf_priority_die|amf_play,
   [8.0, "lady_stand_new", 0, 210, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [3.0, "lady_stand_new_4", 0, 68, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [4.5, "bg_female_idle_stand", 0, 79, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   # [18.0, "vyrn_shieldmaiden_stand", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   # [6.5, "vyrn_shieldmaiden_stand_2", 0, 149, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   # [26.0, "vyrn_shieldmaiden_stand", 0, 499, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   # [10.0, "vyrn_shieldmaiden_stand", 0, 80, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["vyrn_sleeping_on_tree", acf_enforce_all, amf_priority_die|amf_play,
   [9, "vyrn_sleeping_on_tree", 0, 19, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["flute_player", acf_enforce_all, amf_priority_die|amf_play,
   [9, "flute_player", 0, 17, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["cornu_play", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [4.0, "cornu_play", 0, 40, arf_blend_in_1],
],
["order_charge", acf_enforce_all, amf_priority_order|amf_play|amf_client_prediction,
  [4.0, "order_charge", 0, 81, arf_blend_in_1],
],
["greet_simple", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [3.0, "anim_greet_simple", 0, 39, arf_blend_in_1],
],
["greet_simple_mounted", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [3.0, "anim_greet_simple_mounted", 0, 39, arf_blend_in_1],
],
...
##   [2.5, "anim_human", 70000, 70045, arf_blend_in_5],
##   [3.0, "anim_human", 70100, 70150, arf_blend_in_5],
   [19.0, "man_cheer", 0, 617, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [4.5, "cifre_air_thrust2", 0, 146, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
...
["blow_kiss", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction,
  [4.0, "blow_kiss", 0, 13, arf_blend_in_1],
],
...
["arena_stand_idle", 0, amf_client_prediction,
  ...
  ["senator_speak", 0, amf_client_prediction,
    [15.0, "stand_standing_fury_talk", 0, 499, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
  ],
  ["senator_listen", 0, amf_client_prediction,
    [2.0, "stand_clapping_idle_a", 0, 27, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [6.0, "stand_laughting_a", 0, 233, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [4.0, "stand_look_forward_a", 0, 116, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [30.0, "wedding_guest", 0, 906, arf_cyclic],
  ...
  ["player_lyre_standing", acf_enforce_all,amf_play|amf_keep|amf_priority_mount,
      [2.05, "dedal_lyre_standing", 3, 7, arf_blend_in_5|arf_cyclic],
    ],
  ["player_lyre_end", acf_enforce_all, amf_priority_die|amf_play,
    [0.2, "dedal_lyre_standing", 3, 4, arf_blend_in_5|arf_cyclic, 0, (0, 0, 0), 0.25],],
  ["female_lie_sexy", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_play|amf_accurate_body,
    [40.0, "female_lie_sexy", 1, 771, arf_cyclic, 0, (0, 0, 0), 0.25],
  ],
  ["stand_guard_spear", 0, 0,
    [15.0, "stand_guard_spear_1", 0, 199, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [18.0, "stand_guard_spear_2", 0, 239, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [18.0, "stand_guard_spear_3", 0, 239, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [9.0, "stand_guard_spear_4", 0, 80, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [14.0, "stand_guard_spear_5", 0, 179, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
    [10.5, "stand_guard_spear_6", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
  ],
  ["lie_normal", acf_enforce_all|acf_lock_camera, amf_priority_die|amf_play|amf_accurate_body,
    [12.5, "female_lie_sexy", 1, 60, arf_cyclic, 0, (0, 0, 0), 0.25],
  ],
  ["dedal_sitting_2", acf_enforce_all, amf_priority_die|amf_keep,
	  [10.0, "dedal_sitting_2", 1, 945, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],],
  ["circus_1", acf_enforce_all, amf_priority_die|amf_keep,
    [22, "animation_circus_1", 0, 364, arf_cyclic|arf_use_stand_progress],
  ],
  ["circus_2", acf_enforce_all, amf_priority_die|amf_keep,
    [55, "animation_circus_2", 0, 740, arf_cyclic|arf_use_stand_progress],
  ],
  ["circus_3", acf_enforce_all, amf_priority_die|amf_keep,
    [50, "animation_circus_3", 0, 460, arf_cyclic|arf_use_stand_progress],
  ],
  ["stand_still", acf_enforce_all, amf_priority_die|amf_keep,
    [3.0, "stand_man_new3", 50, 50, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
  ],
  ["chariot_rider", acf_enforce_all, amf_priority_mount|amf_keep,
    [16.0, "chariot_1", 0, 20, arf_cyclic],
  ],
  ["dismount_chariot", acf_enforce_all|acf_displace_position, amf_priority_fall_from_horse|amf_play|amf_accurate_body|amf_client_prediction,
    [1.1, "anim_human", horse_move+1103, horse_move+1145,  arf_blend_in_1, 0, (-0.5,0,0)],
  ],
...
##   [2.5, "anim_horse", 505, 580,  arf_blend_in_8],
 ...
 ["unused_horse_anim_1", 0, amf_client_prediction,
    [1, "anim_horse", 600, 644, arf_cyclic|arf_use_stand_progress],
    [1, "anim_horse", 600, 644, arf_cyclic|arf_use_stand_progress],
    [1, "anim_horse", 600, 644, arf_cyclic|arf_use_stand_progress],
  ],
 ["wild_cat_attack", acf_enforce_lowerbody|acf_ignore_slope, amf_priority_rear|amf_play,
   [2, "wild_cat_attack", 0, 25, arf_blend_in_8],
   [2, "wild_cat_attack_2", 0, 29, arf_blend_in_8],
 ],
