...
("looters","Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_looter,15,55)]),
# Ryan END
("generic_bandits","Bandit Gang",icon_peasant|carries_goods(9),0,fac_outlaws,bandit_personality,[(trp_bandit,14,30),(trp_brigand,14,30),(trp_looter,5,15),]),
...
("taiga_bandits","Illyrian Rebels",icon_peasant|carries_goods(2),0,fac_illyrian_bandits,bandit_personality,[(trp_illyrian_bandit,14,58),(trp_illyrian_horseman, 3, 20), (trp_illyrian_infantry, 5, 50),]),
...
("forest_bandits","Iberian Rebels",icon_peasant|carries_goods(2),0,fac_forest_bandits,bandit_personality,[(trp_hispanic_bandit,24,72), (trp_mercenary_horseman, 2, 30), (trp_hispanic_infantry, 2, 50), (trp_hispanic_heavy_infantry, 1, 30),]),
...
("raider_party","Raiders",icon_peasant|carries_goods(16)|pf_quest_party,0,fac_commoners,bandit_personality,[(trp_brigand, 90,105)]),
...
("taiga_bandit_lair","Illyrian Lair",icon_map_bandit_lair|carries_goods(20)|pf_is_static|pf_hide_defenders,0,fac_illyrian_bandits,bandit_personality,[(trp_illyrian_bandit,30,90)]),
...
("forest_bandit_lair" ,"Hispanic Hideout",icon_map_bandit_lair|carries_goods(20)|pf_is_static|pf_hide_defenders,0,fac_forest_bandits,bandit_personality,[(trp_hispanic_bandit,30,90)]),
...
("rebels","Rebels",icon_peasant|carries_goods(2),0,fac_roman_rebells,bandit_personality,[(trp_watchman,15,55),(trp_brigand, 12, 24),(trp_slave_rebel, 30, 70),(trp_slave_warrior, 30, 70),(trp_slave_warrior_2, 20, 40),(trp_slave_warrior_3, 10, 20),]),
...
("slave_revolt","Albus party",icon_peasant|carries_goods(2),0,fac_neutral,quest_personality,[(trp_brigand, 20, 25), (trp_bandit, 10, 15), (trp_slave_rebel, 50, 60),]),
