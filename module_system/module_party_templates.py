...
party_templates = [
("none","none",icon_peasant,0,fac_commoners,merchant_personality,[]),
("rescued_prisoners","Rescued Prisoners",icon_peasant,0,fac_commoners,merchant_personality,[]),
("enemy","Enemy",icon_peasant,0,fac_outlaws,merchant_personality,[]),
("hero_party","Hero Party",icon_peasant,0,fac_commoners,merchant_personality,[]),
####################################################################################################################
...
("cattle_herd","Cattle Herd",icon_peasant|carries_goods(10),0,fac_neutral,merchant_personality,[(trp_cattle,80,120)]),

# Ryan BEGIN
("looters_2","Escaped Slaves",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[]),
("looters","Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[]),
("sarmatian_looter","Sarmatae Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_sarmatian_looter,15,75)]),
("bosporan_looter","Bosporani Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_bosporan_looter,15,75)]),
("judean_looter","Iudaei Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_judean_looter,15,75)]),
("parthian_looter","Parthi Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_parthian_looter,15,75)]),
("persian_looter","Persae Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_persian_looter,15,75)]),
("roman_looter","Romani Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_roman_looter,15,75)]),
("celtic_looter","Celtici Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_celtic_looter,15,75)]),
("germanic_looter","Germani Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_germanic_looter,15,75)]),
("dacian_looter","Daci Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_dacian_looter,15,75)]),
("thracian_looter","Thracici Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_thracian_looter,15,75)]),
("arabian_looter","Arabes Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_arabian_looter,15,75)]),
("syrian_looter","Syri Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_syrian_looter,15,75)]),
("eastern_looter","Orientales Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_eastern_looter,15,75)]),
("berber_looter","Mauri Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_berber_looter,15,75)]),
("garamantian_looter","Garamantes Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_garamantian_looter,15,75)]),
("caucasian_looter","Caucasici Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_caucasian_looter,15,75)]),
("greek_looter","Graeci Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_greek_looter,15,75)]),
("galatian_looter","Galatici Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_galatian_looter,15,75)]),
("illyrian_looter","Illyrici Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_illyrian_looter,15,75)]),
("hispanic_looter","Hispani Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_hispanic_looter,15,75)]),
("gaulish_looter","Galli Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_gaulish_looter,15,75)]),
("nubian_looter","Nubiani Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_nubian_looter,15,75)]),
("saka_looter","Sacae Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_saka_looter,15,75)]),
("egyptian_looter","Aegyptii Latrones",icon_peasant|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_egyptian_looter,15,75)]),
# Ryan END

("steppe_bandits","Alan Raiders",icon_peasant|carries_goods(2),0,fac_alans,bandit_personality,[(trp_alannic_raider,30,45),(trp_alan_horse_archer,20,35),(trp_alan_heavy_horse_archer,15,30)]),
("taiga_bandits","Illyrian Rebels",icon_peasant|carries_goods(2),0,fac_illyrian_bandits,bandit_personality,[(trp_illyrian_rebell,14,58),(trp_illyrian_horseman, 3, 20), (trp_illyrian_infantry, 5, 50),]),
("desert_bandits","Arab Raiders",icon_peasant|carries_goods(30),0,fac_arabian_bandits,bandit_personality,[(trp_desert_bandit,14,68),(trp_arab_noble_cav, 5,20),]),
...
("georgians","Caucasian Raiders",icon_peasant|carries_goods(30),0,fac_georgians,bandit_personality,[(trp_georgian_noble_archer,30,65),(trp_georgian_light_archer,50,115),]),
("sakas","Saka Raiders",icon_peasant|carries_goods(30),0,fac_dahae,bandit_personality,[(trp_saka_amazon,5,15),(trp_saka_heavy_cavalry,25,40),(trp_saka_horse_archer,35,55),]),

("furor_teutonicus","Furor Teutonics",icon_peasant|carries_goods(2),0,fac_furor_teutonicus,bandit_personality,[(trp_germanic_berserker,5,20), (trp_germanic_skirmisher,7,68), (trp_germanic_light_clubman,10,80),(trp_germanic_light_spearman,10,80)]),
("pictonen","Young Warriors",icon_peasant|carries_goods(2),0,fac_picton,bandit_personality,[(trp_celtic_naked_swordman,15,30), (trp_celtic_skirmisher,17,48), (trp_celtic_light_clubman,10,30)]),

("deserters","Deserters",icon_peasant|carries_goods(3),0,fac_deserters,bandit_personality,[]),

#SB : fix icon
("merchant_caravan","Merchant Caravan",icon_peasant|carries_goods(20)|pf_auto_remove_in_town|pf_quest_party,0,fac_commoners,escorted_merchant_personality,[(trp_caravan_master,1,1),(trp_caravan_guard,5,25),(trp_package_slave,3,10)]),
("troublesome_bandits","Troublesome Bandits",icon_peasant|carries_goods(9)|pf_quest_party,0,fac_outlaws,bandit_personality,[(trp_bandit,14,55)]),
("bandits_awaiting_ransom","Bandits Awaiting Ransom",icon_peasant|carries_goods(9)|pf_auto_remove_in_town|pf_quest_party,0,fac_neutral,bandit_personality,[(trp_bandit,24,58),(trp_kidnapped_girl,1,1,pmf_is_prisoner)]),
("kidnapped_girl","Kidnapped Girl",icon_peasant|pf_quest_party,0,fac_neutral,merchant_personality,[(trp_kidnapped_girl,1,1)]),
...
("village_hispanic","Villagers",icon_peasant|pf_civilian,0,fac_innocents,merchant_personality,[(trp_hispanic_peasant,10,15),]),
("village_illyrian","Villagers",icon_peasant|pf_civilian,0,fac_innocents,merchant_personality,[(trp_illyrian_peasant,10,15),]),
("village_gaul","Villagers",icon_peasant|pf_civilian,0,fac_innocents,merchant_personality,[(trp_gaulish_peasant,10,15),]),
("village_nubian","Villagers",icon_peasant|pf_civilian,0,fac_innocents,merchant_personality,[(trp_nubian_peasant,10,15),]),
("village_saka","Villagers",icon_peasant|pf_civilian,0,fac_innocents,merchant_personality,[(trp_saka_peasant,10,15),]),

("spy_partners", "Unremarkable Travellers", icon_peasant|carries_goods(10)|pf_default_behavior|pf_quest_party,0,fac_neutral,merchant_personality,[(trp_spy_partner,1,1),(trp_caravan_guard,5,11)]),
...
("spy", "Ordinary Townsman", icon_peasant|carries_goods(4)|pf_default_behavior|pf_quest_party,0,fac_neutral,merchant_personality,[(trp_spy,1,1)]),
("sacrificed_messenger", "Sacrificed Messenger", icon_peasant|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_neutral,merchant_personality,[]),

("forager_party","Foraging Party",icon_peasant|carries_goods(5)|pf_show_faction,0,fac_commoners,merchant_personality,[]),
("scout_party","Scouts",icon_peasant|carries_goods(1)|pf_show_faction,0,fac_commoners,bandit_personality,[]),
("patrol_party","Patrol",icon_peasant|carries_goods(2)|pf_show_faction,0,fac_commoners,soldier_personality,[]),
#SB : icon change to make it stand out more
("messenger_party","Messenger",icon_peasant|pf_show_faction,0,fac_commoners,merchant_personality,[]),
("raider_party","Raiders",icon_peasant|carries_goods(16)|pf_quest_party,0,fac_commoners,bandit_personality,[(trp_bandit, 90,105)]),
("raider_captives","Raider Captives",0,0,fac_commoners,0,[(trp_peasant_woman,6,30,pmf_is_prisoner)]),
("kingdom_caravan_party","Caravan",icon_peasant|carries_goods(25)|pf_show_faction,0,fac_commoners,merchant_personality,[(trp_caravan_master,1,1),(trp_caravan_guard,12,40),(trp_package_slave,3,10)]),
("prisoner_train_party","Slave Train",icon_peasant|carries_goods(5)|pf_show_faction,0,fac_commoners,merchant_personality,[(trp_mercenary_horseman,50,60),]),
("default_prisoners","Default Prisoners",icon_peasant,0,fac_commoners,0,[(trp_bandit,5,10,pmf_is_prisoner)]),

("routed_warriors","Routed Enemies",icon_peasant,0,fac_commoners,soldier_personality,[]),


# ("center_reinforcements","Reinforcements", icon_peasant|pf_show_faction|carries_goods(4),0,fac_commoners,escorted_merchant_personality,[]),

("kingdom_hero_party","War Party",icon_peasant|pf_show_faction|pf_default_behavior,0,fac_commoners,soldier_personality,[]),
##mercenary bands
("mercenary_guard", "Mercenary Guard", 0, 0, fac_commoners, 0,
[("trp_watchman", 30,30),("trp_caravan_guard", 15,15),("trp_mercenary_bowman",15,15),] ),#60
("mercenary_warband", "Mercenary Warband", 0, 0, fac_commoners, 0,
[("trp_mercenary_swordsman", 30,30),("trp_hired_blade", 15,15),("trp_mercenary_bowman",15,15),] ),#60
...
[("trp_alannic_raider", 25,25),("trp_alan_heavy_horse_archer", 10,10),("trp_alan_horse_archer",15,15),] ),#50
...
[("trp_garamantian_horseman_merc", 30,30),("trp_garamantian_noble_horseman_merc", 20,20),] ),#50
("mercenary_gaetulian", "Gaetulian Mercenaries", 0, 0, fac_commoners, 0,
[("trp_gaetuli_horseman_merc", 30,30),("trp_gaetuli_noble_horseman_merc", 30,30),] ),#60
...
("mercenary_caucasia","North Caucasian Raiders",icon_peasant|carries_goods(30),0,fac_commoners,0,
[(trp_georgian_noble_archer,40,40),(trp_georgian_light_archer,20,20),]),
("mercenary_dahae","Saka Raiders",icon_peasant|carries_goods(30),0,fac_commoners,0,
[(trp_saka_horse_archer,35,35),(trp_saka_heavy_cavalry,25,25),]),
("mercenary_saka_amazon","Saka Amazons",icon_peasant|carries_goods(30),0,fac_commoners,0,
[(trp_saka_amazon,50,50)]),

("custom_infantry_retinue","Infantry retinue (custom)",icon_peasant,0,fac_commoners,aggressiveness_0|courage_15,
[(trp_custom_standard_bearer,1,1),(trp_custom_hornman,1,1),(trp_custom_infantry,80,80)]),
("custom_cavalry_retinue","Cavalry retinue (custom)",icon_peasant,0,fac_commoners,aggressiveness_0|courage_15,
[(trp_custom_standard_bearer_cav,1,1),(trp_custom_skirmisher_cav,30,30),(trp_custom_cav_barb,30,30)]),
("custom_skirmisher_retinue","Skirmisher retinue (custom)",icon_peasant,0,fac_commoners,aggressiveness_0|courage_15,
...
[(trp_gaetuli_noble_horseman_merc,20,20),(trp_gaetuli_horseman_merc,45,45)] ),
("culture_12_town_watch", "Garamantian Townwatch", 0, 0, fac_commoners, 0,
[(trp_garamantian_noble_horseman_merc,20,20),(trp_garamantian_horseman_merc,45,45)] ),
...
("culture_15_town_watch", "Syrian Townwatch", 0, 0, fac_commoners, 0,
...
[(trp_egyptian_archers,25,25),(trp_egyptian_infantry_heavy,25,25),(trp_egyptian_infantry_light,30,30),("trp_egyptian_officer", 2, 2)] ),
...
[(trp_judean_light_spearman,25,25),(trp_judean_light_clubman,25,25),(trp_judean_slinger,15,15),(trp_judean_rebel,10,10),(trp_judean_hornman,1,1),(trp_judean_standard_bearer,1,1)] ),
...
("kingdom_10_reinforcements_a", "Berber Levies", 0, 0, fac_commoners, 0,
[(trp_gaetulian_skirmisher,25,25),(trp_gaetulian_archer,20,20),(trp_gaetulian_noble_spearman,25,25),(trp_gaetulian_standard_bearer,1,1),(trp_gaetulian_hornman,1,1)] ),
("kingdom_10_reinforcements_b", "Berber Retinue", 0, 0, fac_commoners, 0,
[(trp_gaetulian_noble_spearman,35,35),(trp_gaetulian_archer,20,20),(trp_gaetulian_skirmisher_cav,20,20),(trp_gaetulian_standard_bearer,1,1),(trp_gaetulian_hornman,1,1)] ),
("kingdom_10_reinforcements_c", "Berber Guard", 0, 0, fac_commoners, 0,
[(trp_gaetulian_noble_cav,25,25),(trp_gaetulian_skirmisher_cav,35,35)] ),

("kingdom_11_reinforcements_a", "Garamantian Levies", 0, 0, fac_commoners, 0,
[(trp_garamantian_skirmisher,25,25),(trp_garamantian_archer,20,20),(trp_garamantian_noble_spearman,25,25),(trp_garamantian_standard_bearer,1,1),(trp_garamantian_hornman,1,1)] ),
("kingdom_11_reinforcements_b", "Garamantian Retinue", 0, 0, fac_commoners, 0,
[(trp_garamantian_noble_spearman,35,35),(trp_garamantian_archer,20,20),(trp_garamantian_skirmisher_cav,20,20),(trp_garamantian_standard_bearer,1,1),(trp_garamantian_hornman,1,1)] ),
("kingdom_11_reinforcements_c", "Garamantian Guard", 0, 0, fac_commoners, 0,
[(trp_garamantian_noble_cav,25,25),(trp_garamantian_skirmisher_cav,35,35)] ),

("steppe_bandit_lair" ,"Alan Camp",icon_map_bandit_lair|carries_goods(20)|pf_is_static|pf_hide_defenders,0,fac_alans,bandit_personality,[(trp_alannic_raider,30,90)]),
("taiga_bandit_lair","Illyrian Lair",icon_map_bandit_lair|carries_goods(20)|pf_is_static|pf_hide_defenders,0,fac_illyrian_bandits,bandit_personality,[(trp_illyrian_rebell,30,90)]),
...
("bandit_lair_templates_end","{!}bandit_lair_templates_end",icon_peasant|carries_goods(2)|pf_is_static,0,fac_outlaws,bandit_personality,[(trp_sea_raider,15,30)]),

("leaded_looters","Band of robbers",icon_peasant|carries_goods(8)|pf_quest_party,0,fac_neutral,quest_personality,[(trp_looter_leader,1,1),(trp_looter,3,3)]),

("dplmc_gift_caravan","Your Caravan",icon_peasant|carries_goods(25)|pf_show_faction,0,fac_commoners,escorted_merchant_personality,[(trp_caravan_master,1,1),(trp_caravan_guard,5,25),(trp_package_slave,3,10)]),
# #recruiter kit begin
# ("dplmc_recruiter","Recruiter",icon_peasant|pf_show_faction,0,fac_neutral,merchant_personality,[(trp_dplmc_recruiter,1,1)]),
# #recruiter kit end
##diplomacy end
("refugees","Refugees",icon_peasant|pf_auto_remove_in_town|pf_civilian,0,fac_innocents,merchant_personality,[]),
...
#first cohort
("legio_xxii_primigenia_staff","Cohors Prima Legio I Adjuterix",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_iii_augusta_staff","Cohors Prima Legio III Augusta ",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_v_alaudae_staff","Cohors Prima Legio V Alaudae",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_xxi_rapax__staff","Cohors Prima Legio XXI Rapax",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_xx_valeria_victrix_staff","Cohors Prima Legio XX Valeria Victrix",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_vi_victrix_staff","Cohors Prima Legio VI Victrix",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_xi_claudia_staff","Cohors Prima Legio XI Claudia",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_xiii_gemina_staff","Cohors Prima Legio XIII Gemina",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_v_macedonia_staff","Cohors Prima Legio V Macedonica",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_vi_ferrata_staff","Cohors Prima Legio VI Ferrata",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("legio_x_fretensis_staff","Cohors Prima Legio X Fretensis",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("praetoriani_staff","Cohors Prima Praetoriani",icon_peasant,0,fac_kingdom_7,soldier_personality,
...
("player_legion_staff","Staff",icon_peasant,0,fac_player_faction,aggressiveness_0|courage_15,
...
#standard cohort
("legio_xxii_primigenia_cohors","Cohors Legio I Adjuterix",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_xxii_primigenia,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1)]),#
("legio_iii_augusta_cohors","Cohors Legio III Augusta",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_iii_augusta,80,80), (trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1)]),
("legio_v_alaudae_cohors","Cohors Legio V Alaudae",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_v_alaudae,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("legio_xxi_rapax__cohors","Cohors Legio XXI Rapax",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_xxi_rapax,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1)]),
("legio_xx_valeria_victrix_cohors","Cohors Legio XX Valeria Victrix",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_xx_valeria_victrix,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("legio_vi_victrix_cohors","Cohors Legio VI Victrix",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_vi_victrix,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("legio_xi_claudia_cohors","Cohors Legio XI Claudia",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_xi_claudia,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("legio_xiii_gemina_cohors","Cohors Legio XIII Gemina",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_xiii_gemina,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("legio_v_macedonia_cohors","Cohors Legio V Macedonica",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_v_macedonia,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("legio_vi_ferrata_cohors","Cohors Legio VI Ferrata",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_vi_ferrata,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("legio_x_fretensis_cohors","Cohors Legio X Fretensis",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_legio_x_fretensis,80,80),(trp_centurio_west,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("praetoriani_cohors","Cohors Praetoriani",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_praetoriani_milites,80,80),(trp_centurio_preatoriani,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("player_cohort","cohort",icon_peasant,0,fac_player_faction,aggressiveness_0|courage_15,
[(trp_custom_legionary,80,80),(trp_custom_centurio,1,1),(trp_custom_signifer,1,1),(trp_custom_cornicen,1,1)]),

#auxilia##9 inf cohorts
("cohors_aux","Cohors Auxiliarum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_signifer,1,1),(trp_cornicen,1,1),(trp_aux_centurio,1,1),(trp_aux_inf, 80, 80),]),
("cohors_alp","Cohors Alporum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_alporum, 80, 80)]),
("cohors_afr","Cohors Maurorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_maurorum, 80, 80)]),
("cohors_hisp","Cohors Hispanorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_hispanorum, 80, 80)]),
("cohors_tung","Cohors Tungrorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_tungrorum, 80, 80)]),
("cohors_gal","Cohors Gallorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_gallorum, 80, 80)]),
("cohors_bata","Cohors Batavorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_signifer,1,1),(trp_cornicen,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_batavorum, 80, 80)]),
("cohors_brit","Cohors Brittonum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_brittonum, 80, 80)]),
("cohors_thrac","Cohors Thracum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_thracum, 80, 80)]),
("cohors_jud","Cohors Petreorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_inf_petreorum, 80, 80)]),
## 6 cav alae
("ala_batavorum","Ala Batavorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_cav_vexilarius,5,5),(trp_aux_cav_batavorum, 80, 80),(trp_aux_cav_decurio,1,1),]),
("ala_asia","Ala Commagenorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_cav_vexilarius,5,5),(trp_aux_cav_commagenorum, 80, 80),(trp_aux_cav_decurio,1,1),]),
("ala_gal","Ala Gallorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_cav_vexilarius,5,5),(trp_aux_cav_gallorum, 80, 80),(trp_aux_cav_decurio,1,1),]),
("ala_syr","Ala Ituraeorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_cav_vexilarius,5,5),(trp_aux_cav_ituraeorum, 80, 80),(trp_aux_cav_decurio,1,1),]),
("ala_aux","Ala Auxiliarum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_cav_vexilarius,5,5),(trp_aux_cav, 60, 60),(trp_aux_cav_eastern, 60, 60),(trp_aux_cav_decurio,1,1),]),
("ala_preat","Ala Praetoriani",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_cav_vexilarius_praetorian,5,5),(trp_aux_cav_praetoriani, 80, 80),(trp_aux_cav_decurio,1,1),]),
("ala_preat_2","Ala Germani Corporis Custodes",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_cav_vexilarius_praetorian,5,5),(trp_aux_cav_praetoriani_2, 80, 80),(trp_aux_cav_decurio,1,1),]),
("player_aux_inf","infantry",icon_peasant,0,fac_player_faction,aggressiveness_0|courage_15,
...
("player_aux_cav","cavalry",icon_peasant,0,fac_player_faction,aggressiveness_0|courage_15,
[(trp_custom_cav_of, 1,1),(trp_custom_cav_vex,5,5),(trp_custom_cav, 40,40),(trp_custom_aux_cav, 40,40)]),

("praetoriani_archer_cohors","Cohors Sagittarii Praetoriani",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_archer_praetoriana,80,80),(trp_centurio_preatoriani,1,1),(trp_cornicen,1,1),(trp_signifer,1,1),]),
("engineer_cohort","Manipulus Ballistarium",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_ballistarii,25,25),]),
("engineer_cohort_custom","Manipulus Ballistarium (custom)",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_custom_balista,25,25),]),

("cohors_aux_archer","Cohors Auxiliarum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_signifer,1,1),(trp_cornicen,1,1),(trp_aux_centurio,1,1),(trp_aux_archer, 80,80),]),
("cohors_alp_archer","Cohors Alporum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_archer_alporum,80,80),]),
("cohors_afr_archer","Cohors Maurorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_archer_maurorum, 80,80),]),
("cohors_hisp_archer","Cohors Hispanorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_slinger, 80,80),]),
("cohors_tung_archer","Cohors Tungrorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_archer_tungrorum, 80,80),]),
("cohors_gal_archer","Cohors Gallorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_archer_gallorum, 80,80),]),
("cohors_bata_archer","Cohors Batavorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_aux_signifer,1,1),(trp_cornicen,1,1),(trp_aux_centurio,1,1),(trp_aux_archer_batavorum, 80,80),]),
("cohors_brit_archer","Cohors Brittonum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_archer_brittonum, 80,80),]),
("cohors_thrac_archer","Cohors Thracum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_archer_thracum, 80,80),]),
("cohors_jud_archer","Cohors Petreorum",icon_peasant,0,fac_kingdom_7,soldier_personality,
[(trp_cornicen,1,1),(trp_aux_signifer,1,1),(trp_aux_centurio,1,1),(trp_aux_archer_sryrorum, 80,80),]),
("player_aux_archer","infantry",icon_peasant,0,fac_player_faction,aggressiveness_0|courage_15,
[(trp_custom_aux_cornicern,1,1),(trp_custom_aux_signifer,1,1),(trp_custom_aux_centurio,1,1),(trp_custom_sagitarius, 80,80)]),

##rebells begin
("germans","Germanic Revolt",icon_peasant|carries_goods(50)|pf_show_faction,0,fac_commoners,rebel_personality,[(trp_germanic_noble_swordsman, 250, 350),(trp_germanic_light_clubman, 350,450),(trp_germanic_light_spearman, 350, 450),(trp_germanic_berserker, 150, 250),(trp_germanic_skirmisher, 200, 300),(trp_germanic_archer, 100, 200)]),
("brits","Celtic Revolt",icon_peasant|carries_goods(50)|pf_show_faction,0,fac_commoners,rebel_personality,[(trp_celtic_noble_swords, 250, 350),(trp_celtic_light_clubman, 350, 450),(trp_celtic_light_spearman, 350, 450),(trp_celtic_naked_swordman, 150, 250),(trp_celtic_skirmisher, 200, 300),(trp_celtic_archer, 100, 200)]),
("nomads","Tribal Revolt",icon_peasant|carries_goods(50)|pf_show_faction,0,fac_commoners,rebel_personality,[(trp_sarmatian_noble_horseman, 250, 350),(trp_sarmatian_light_horsearcher, 350, 450),(trp_sarmatian_light_horseman, 350, 450),(trp_sarmatian_heavy_horseman, 150, 250),(trp_sarmatian_light_spearman, 200, 300),(trp_sarmatian_archers, 100, 200)]),
("cals","Caledonian Revolt",icon_peasant|carries_goods(50)|pf_show_faction,0,fac_commoners,rebel_personality,[(trp_caledonian_noble_swords, 250, 350),(trp_caledonian_light_clubman, 350, 450),(trp_caledonian_light_spearman, 350, 450),(trp_caledonian_naked_swordman, 150, 250),(trp_caledonian_skirmisher, 200, 300),(trp_caledonian_archer, 100, 200)]),

("dacians","Dacian Revolt",icon_peasant|carries_goods(50)|pf_show_faction,0,fac_commoners,rebel_personality,[(trp_dacian_noble_inf, 250, 350),(trp_dacian_light_spearman, 350, 450),(trp_dacian_light_swordman, 350, 450),(trp_dacian_noble_cav, 150, 250),(trp_dacian_skirmishers, 200, 300),(trp_dacian_archers, 100, 200)]),
#end
("jewish_revolt","Great Jewish Revolt",icon_peasant|carries_goods(2),0,fac_judean_rebels,bandit_personality,[(trp_judean_rebel,550,650),(trp_kreta_archer,30,50),(trp_mercenary_swordsman, 30,50),(trp_judean_skirmisher,100,200),(trp_judean_light_clubman,100,200)]),
...
("sea_traders", "Traders",icon_peasant|carries_goods(25)|pf_show_faction,0,fac_commoners,merchant_personality,[(trp_caravan_master,1,1),(trp_mercenary_swordsman,20,30),(trp_caravan_guard,5,20),(trp_hired_blade,5,10),(trp_mercenary_bowman,5,10),(trp_package_slave,3,10)]),
#("mine","Mine",icon_map_bandit_lair|pf_is_static|pf_hide_defenders|pf_always_visible|pf_label_small,0,fac_neutral,courage_15,[]),

("rebels","Rebels",icon_peasant|carries_goods(2),0,fac_roman_rebells,bandit_personality,[(trp_watchman,15,55),(trp_roman_bandit, 12, 24),(trp_slave_rebel, 30, 70),(trp_slave_warrior, 30, 70),(trp_slave_warrior_2, 20, 40),(trp_slave_warrior_3, 10, 20),]),
...
("patrols_end","Patrol",icon_peasant,0,fac_player_faction,aggressiveness_0|courage_15,[]),
##costum player legion

("slave_revolt","Albus party",icon_peasant|carries_goods(2),0,fac_neutral,quest_personality,[(trp_roman_bandit, 20, 25), (trp_bandit, 10, 15), (trp_slave_rebel, 50, 60),]),
