...
("description_crown_shah", "test"),
("description_laurel_gold", "test"),
("description_female_crown", "test"),
("description_laurel_silver", "test"),
("description_pharaoh_crown", "test"),
("description_pilos_ultimate", "test"),
("description_felt_steppe_cap", "test"),
("description_laurel_wearth", "test"),
("description_minotaur_armor", "test"),
("description_cupid_arrow", "test"),
