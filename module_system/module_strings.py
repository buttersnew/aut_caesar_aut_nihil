...
("description_gallic_spear_4", "test"),
("description_ancient_spatha", "test"),
("description_augustus_armor", "test"),
("description_aslans_fur", "test"),
("description_ancient_helm_light", "test"),
("description_ancient_helm_heavy", "test"),
("description_ancient_boots_heavy", "test"),
("description_ancient_plate_armor", "test"),
("description_ancient_plate_armor2", "test"),
("description_ancient_leather_armor", "test"),
("description_ancient_spear", "test"),
("description_ancient_axe", "test"),
("description_ancient_sword", "test"),
("description_ancient_shield", "test"),
("description_anti_fooling_paint", "test"),
("description_aegis", "test"),
("description_caesars_sword", "test"),
("description_caesars_sword_melee", "test"),
("description_maske", "test"),
("description_roman_rich_vitellius", "test"),
("description_animal_boar", "test"),
("description_animal_dear", "test"),
("description_animal_wolf", "test"),
("description_wild_elephant", "test"),
("description_wild_lion", "test"),
("description_wild_lion_2", "test"),
("description_female_slave1", "test"),
("description_female_slave2", "test"),
("description_female_slave3", "test"),
("description_female_slave4", "test"),
("description_roman_female_augusta", "test"),
("description_roman_female_augusta_2", "test"),
("description_seiden_dress", "test"),
