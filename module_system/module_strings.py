...
("description_mithras", "test"),
("description_mirror_poppaea", "test"),
("description_allat", "test"),
("description_holy_grail", "test"),
("description_danish_longsword_2", "test"),
("description_arminius_mask", "test"),
("description_arminius_spatha", "test"),
("description_thunder", "test"),
("description_dragon", "test"),
("description_african_longbow", "test"),
("description_dragon_arrows", "test"),
("description_thunder_arrows", "test"),
("description_linothorax_alexander", "test"),
("description_alexanders_helm", "test"),
("description_armor_of_african_gods", "test"),
("description_khopesh1", "test"),
("description_holy_lance", "test"),
