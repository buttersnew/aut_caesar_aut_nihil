...
("description_menorah", "test"),
("description_scythian_bong", "test"),
("description_perfume_special", "test"),
("description_lyre_rich", "test"),
("description_kush_crown", "test"),
("description_parthian_female_hat", "test"),
