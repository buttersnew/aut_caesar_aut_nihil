...
("description_hercules_club", "Description:^^The club of Donar is a holy relict of the Germanic people. They made it out of gold and gemstones which they obtained from raiding Roman border villages.^^Background:^^According to Tacitus, the Germans worship Hercules with animal sacrifices. Tacitus refers to Donar (Thor) as Hercules. Tacitus also records a wood beyond the river Weser as dedicated to Hercules (Donar). Tacitus also writes about a deity known as Hercules Magusanus was worshipped in Germania Inferior. The symbol of Hercules is his club and his lion skin.^^"),
("description_celtic_carnyx", "Description:^^Unlike its regular counterparts (which are made out of bronze), this carnyx is made out of pure gold, which makes it a sign of wealth.^^Background:^^The carnyx was a wind instrument from Celts used between 200 B.C. and 200 A.D. It was used for signals and to rally troops during battle and may also in ceremonies. The instrument's significant height allowed it to be heard over the heads of the participants in battles or ceremonies.^^"),
("description_dacian_treasure", "Description:^^The Dacian kings collected all kinds of gemstones and plenty of gold over the centuries. This treasury is clearly a symbol of great wealth.^^Background:^^According to Cassius Dio, Decebalus, the last Dacian king, has hidden his treasury in a river. Cassius Dio writes: 'The treasures of Decebalus were also discovered, though hidden beneath the river Sargetia, which ran past his palace. With the help of some captives Decebalus had diverted the course of the river, made an excavation in its bed, and into the cavity had thrown a large amount of silver and gold and other objects of great value that could stand a certain amount of moisture; then he had heaped stones over them and piled on earth, afterwards bringing the river back into his course. He also had caused the same captives to deposit his robes and other articles of a like nature in caves, and after accomplishing this had made away with them to prevent them from disclosing anything. But Bicilis, a companion of his who knew what had been done, was seized and gave information about these things.'^^"),
("description_menorah", "Description:^^this candelabrum is a holy artefact of Judaism. It is lavishly decorated with gold and gemstones.^^Background:^^The menorah is a seven-branched candelabrum that is described in the Hebrew Bible and in later ancient sources as having been used in the Tabernacle and in the Temple in Jerusalem. Into prehistory, its iconography can be traced to representations of the sacred tree. Since ancient times, it has served as a symbol representing the Jewish people and Judaism in both the Land of Israel and the Diaspora."),
("description_scythian_bong", "Description:^^This item is a water pipe made out of gold used to smoke anything that makes you high and happy.^^Background:^^In Southern Russia, archaeologists discovered what they deduced to be two 2,400 years old pure gold bongs. It was discovered in a buried chamber and covered in clay and lined with stones. The items belonged to the Scythians. Legend has it that the nomadic Iranian tribe smoked cannabis and opium in order to alter their state of mind before going into battle. Herodotus wrote about the Scythians that they used a plant to produce smoke that no Grecian vapor-bath can surpass which made them shout aloud."),
("description_perfume_special", "Description:^^This fragrance is the ultimate perfection of smelling. Imagine a soft caress of a morning breeze, kissed by the petals of a thousand blossoms. The top notes, a burst of citrus sunrises, awaken the senses with the freshness of a new dawn. Citrus zests playfully twirl, a vibrant dance of lemons, bergamot, and mandarins, painting the air with a lively canvas.^^Background:^^The art of making perfumes began in ancient Egypt, Mesopotamia and the Indus Valley civilization. The Egyptians used a compund incense called Kyphi during religious ceremonies. The Egyptian recipes have sixteen ingredients each, which shows the expense people put into it."),
("description_lyre_rich", "Description:^^This lyre is made out of pure gold. Its strings are made out of golden hair. The lyre is property of Nero.^^Background:^^Nero was famous for his artistic passions. Nero's devotion to music exceeded what was socially acceptable for a Roman of his class."),
("description_kush_crown", "Description:^^The crown of Kush is lavishly decorated with gold and ornaments.^^Background:^^The item is based on pictures of statues of Nubian rulers."),
("description_parthian_female_hat", "Description:^^This female crown is worn by the wife of the Shahanshah. It's lavishly decorated with gold and gemstones.^^Background:^^Roughly based on depictions of Persian princesses/queens in movies (like the Alexander movie) though not historical accurate."),
("description_crown_shah", "Description:^^This is the crown of the king of kings, the ruler of Persia. Its lavishly decorated with gold and gemstones.^^Background:^^This particular crown item is purely fictional and based on nothing. Most likely the Parthian kings ruling over Persia had expensive crowns."),
...
("description_laurel_wearth", "Description:^^A laurel wreath, typical award for the victor of competitions.^^Background:^^In Greek mythology, the god Apollo is usually depicted wearing a laurel wreath on his head. Wreaths were awarded to victors in athletic competitions, including the ancient Olympics. In Rome they were symbols of martial victory, crowning a successful commander during his triumph. Usually, a slave was holding a golden laurel wreath over the head of the triumphator."),
("description_minotaur_armor", "Description:^^This is just a stinky, old fur. People will be disgusted if you wear it in public.^^Background:^^It's a stinky, old fur. What do you expect?"),
("description_cupid_arrow", "Description:^^The legendary arrow of Cupid. However is stung with it will fall in love with the first person they see.^^Description:^^Cupid is the god of desire, erotic love and attrection. Cupid carries two kinds of arrows, or darts, one with a sharp golden point, and the other with a blunt tip of lead. A person wounded by the golden arrow is filled with uncontrollable desire, but the one struck by the lead feels aversion and desires only to flee."),
("description_mithras", "Description:^^Statue of Mithras killing the bull, made out of fine marble from India.^^Background:^^The model of this statue is a digital scan of a statue from second century AD found in Rome. Mithras is shown in eastern costume, including trousers and a Phrygian cap. A dog and snake are shown trying to lick the blood and a scorpion is attacking the bull's genitals. It’s an object of the British museum with object number 1825,0613.1."),
("description_mirror_poppaea", "Description:^^This golden mirror has a portrait of Poppaea Sabina on the background.^^Background:^^The mirror and its picture is purely fictional."),
("description_allat", "Description:^^This is a statue of the goddess Al-lat made of pure gold.^^Background:Al-lat is a (pre-islamic) Arabian goddess. The depiction is purely fictional."),
("description_holy_grail", "Description:^^This is a cup which likely belonged to a man named Chrestos.^^Background: Chrestos was a common slave name in the first century AD."),
("description_danish_longsword_2", "Description:^^This longsword was forged by the Germanic gods and is a present of Freya.^^Background:^^It's based on swords found in Scandinavia by that time period."),
("description_arminius_mask", "Description:^^A galea with a golden mask. It is said that Arminius made the golden mask using the loot from the battle of Teuteburg.^^Background:^^Arminius is a historical person but this mask is fictional."),
("description_arminius_spatha", "Description:^^The spatha of Arminius.^^Background:^^Arminius is a historical person and likely aslo yielded a sword, but this particular one is purely fictional."),
("description_thunder", "Description:^^This composite bow is called 'thunder' as its powerful like a thunder.^^Background:^^This bow is purely fictional."),
("description_dragon", "Description:^^This composite bow is called 'dragon' as its powerful like a dragon.^^Background:^^This bow is purely fictional."),
...
("description_ancient_helm_light", "Description:^^This helemt is thousands of years old and was made by Vulcanus.^^Description:^^Model is based on archiologically findings dated back to bronze age"),
("description_ancient_helm_heavy", "Description:^^This helemt is thousands of years old and was forged by Vulcanus."),
("description_ancient_boots_heavy", "Description:^^This greaves are thousands of years old and were forged by Vulcanus."),
("description_ancient_plate_armor", "Description:^^This bronze armour is thousands of years old and was forged by Vulcanus."),
("description_ancient_plate_armor2", "Description:^^This bronze armour is thousands of years old and was forged by Vulcanus."),
("description_ancient_leather_armor", "Description:^^This leather armour is thousands of years old and was made by Vulcanus."),
("description_ancient_spear", "Description:^^This bronze xpear is thousands of years old and was forged by Vulcanus."),
("description_ancient_axe", "Description:^^This bronze axe is thousands of years old and was forged by Vulcanus."),
("description_ancient_sword", "Description:^^This bronze sword is thousands of years old and was forged by Vulcanus."),
("description_ancient_shield", "Description:^^This bronze shield is thousands of years old and was forged by Vulcanus."),
("description_anti_fooling_paint", "Description:^^This anti fooling paint protects boats and ships from fooling and from barnacles which grow on the ship hull. It is made by Farbius, only he knows the recept.^^Background:^^Barnacles are small crustaceans that attach themselves to submerged surfaces, including the hulls of ships. This process is known as biofouling."),
("description_aegis", "Description:^^This is the shield of Zeus, forged by Hephaestus. It features the head of a Gorgon.^^Background:^^In Greek mythology, the aegis (or aigis) is closely associated with Zeus, the king of the gods. The aegis is typically described as a protective cloak or shield associated with divine power. It is sometimes depicted as bearing the head of Gorgon, a creature with snakes for hair whose gaze could turn people to stone. The aegis was a symbol of divine protection and intimidation, often used by Zeus or his daughter Athena. In some myths, other gods and goddesses are also described as using the aegis."),
("description_caesars_sword", "Description:^^This is the gladius of Gaius Julius Caesar. It is called 'Crocea Mors', which is Latin for 'yellow death'. Everyone who is struck with the sword either has his head chopped off or else was so wounded that they have no hope of ever recovering.^^Background:^^According to legends, when Caesar was invading Britannia, he fought against a Britanic Lord called Nennius. Caesar struck Nennius a blow to the head, but his sword got stuck in Nennius's shield. After they separated in the melée, Nennius threw away his own sword and attacked the Romans with Caesar's sword, killing many, including the tribune Quintus Laberius Durus. Fifteen days after the battle Nennius died of his head wound, and was buried at London (the 'City of the Trinovantes'), near the North Gate. Caesar's sword, Crocea Mors, was buried with him."),
("description_caesars_sword_melee", "Description:^^This is the gladius of Gaius Julius Caesar. It is called 'Crocea Mors', which is Latin for 'yellow death'. Everyone who is struck with the sword either has his head chopped off or else was so wounded that they have no hope of ever recovering.^^Background:^^According to legends, when Caesar was invading Britannia, he fought against a Britanic Lord called Nennius. Caesar struck Nennius a blow to the head, but his sword got stuck in Nennius's shield. After they separated in the melée, Nennius threw away his own sword and attacked the Romans with Caesar's sword, killing many, including the tribune Quintus Laberius Durus. Fifteen days after the battle Nennius died of his head wound, and was buried at London (the 'City of the Trinovantes'), near the North Gate. Caesar's sword, Crocea Mors, was buried with him."),
("description_maske", "Description:^^This is a mask with a cloak. It is worn by Bacchus to hide his face. Player is not able to own this item.^^Background:^^Nothing more to say."),
("description_roman_rich_vitellius", "Description:^^This body item is Vitellius fat gut.^^Background:^^Aulus Vitellius was known for his corpulent and indulgent lifestyle. Historical accounts describe Vitellius as being overweight and excessively fond of luxury, gluttony, and extravagant banquets. His physical appearance, particularly his obesity, is often highlighted in historical sources."),
("description_animal_boar", "Description:^^This is a boar which player may hunt. Player can't have this item in his inventory.^^Background:^^Boars are dangerous animals."),
("description_animal_dear", "Description:^^This is a dear which player may hunt. Player can't have this item in his inventory.^^Background:^^Dears are easily scared and may run away."),
("description_animal_wolf", "Description:^^This is a wolf which player may hunt. Player can't have this item in his inventory.^^Background:^^Wolves are dangerous animals."),
("description_wild_elephant", "Description:^^This is an elephant which player may hunt. Player can't have this item in his inventory.^^Background:^^Elephants are dangerous animals."),
("description_wild_lion", "Description:^^This is a lion which player may hunt. Player can't have this item in his inventory.^^Background:^^Lions are dangerous animals."),
("description_wild_lion_2", "Description:^^This is a leopard which player may hunt. Player can't have this item in his inventory.^^Background:^^Leopards are dangerous animals."),
("description_female_slave1", "Description:^^This is a dancers outfit made out of slightly transparent silk.^^Background:^^Hot or not?"),
("description_female_slave2", "Description:^^This is a dancers outfit made out of slightly transparent silk.^^Background:^^Hot or not?"),
("description_female_slave3", "Description:^^This is a dancers outfit made out of slightly transparent silk.^^Background:^^Hot or not?"),
